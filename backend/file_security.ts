...
export const ALLOWED_MIME_TYPES = {
  products: ['image/jpeg', 'image/jpg', 'image/png', 'image/gif', 'image/webp', 'image/svg+xml'],
  categories: ['image/jpeg', 'image/jpg', 'image/png', 'image/gif', 'image/webp', 'image/svg+xml'],
  brands: ['image/jpeg', 'image/jpg', 'image/png', 'image/gif', 'image/webp', 'image/svg+xml'],
  avatars: ['image/jpeg', 'image/jpg', 'image/png', 'image/gif', 'image/webp'],
  gallery: ['image/jpeg', 'image/jpg', 'image/png', 'image/gif', 'image/webp', 'video/mp4'],
  banners: ['image/jpeg', 'image/jpg', 'image/png', 'image/webp'],
  blogs: ['image/jpeg', 'image/jpg', 'image/png', 'image/gif', 'image/webp'],
  ...
  'homepage-editorial': ['image/jpeg', 'image/jpg', 'image/png', 'image/webp']
};
