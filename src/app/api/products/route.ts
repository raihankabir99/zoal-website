...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const productPayload = {
      ...
      is_popular: !!body.isPopular || !!body.popular || !!body.is_popular,
      ...
      is_limited_edition: !!body.isLimitedEdition || !!body.is_limited_edition,
      is_seasonal: !!body.isSeasonal || !!body.is_seasonal,
      is_staff_pick: !!body.isStaffPick || !!body.is_staff_pick,
      is_luxury_choice: !!body.isLuxuryChoice || !!body.is_luxury_choice,
      category: body.category || 'coffee',
      category_id: body.category_id || 'cat-1',
      product_type: body.productType || body.product_type || 'Coffee',
      brand: body.brand || '',
