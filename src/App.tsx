...
function AppContent() {
  ...
  return (
    <div className="bg-black text-white min-h-screen font-sans selection:bg-gold-pure selection:text-black relative overflow-x-clip">
      <SEO currentPage={currentPage} selectedProduct={selectedProduct} selectedPost={selectedPost} />
              ...
              <section className="bg-black py-12 sm:py-24 border-b border-white/5">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div 
                    ...
                    className="md:hidden flex overflow-x-auto snap-x snap-mandatory touch-pan-x gap-4 px-[14vw] sm:px-[13vw] py-4 -mx-4 sm:-mx-6 scroll-smooth [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden"
                  >
