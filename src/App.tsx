...
function AppContent() {
  ...
  useEffect(() => {
    ...
    // Check if Development Preview Dev Mode is active
    fetch('/api/auth/dev-config')
      ...
      .then(config => {
        ...
        proceedWithStandardAuth();
      })
      .catch(() => {
        if (active) proceedWithStandardAuth();
      });

    function proceedWithStandardAuth() {
