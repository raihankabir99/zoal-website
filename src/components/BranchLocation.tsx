...
export default function BranchLocation() {
  ...
  return (
    <section className="py-20 bg-[#050505] border-y border-white/5" dir={isAr ? 'rtl' : 'ltr'}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.8 }}
            className="w-full h-[380px] md:h-[420px] lg:h-[450px] overflow-hidden rounded-sm border border-white/5"
          >
            <iframe
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.8 }}
            className="border border-white/5 bg-zinc-950/40 backdrop-blur-sm p-8 rounded-sm shadow-xl flex flex-col justify-center space-y-6 text-start"
          >
