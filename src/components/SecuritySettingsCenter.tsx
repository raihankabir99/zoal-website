...
export default function SecuritySettingsCenter({
  ...
  const [bizForm, setBizForm] = useState({
    ...
    address: globalSettings.address || 'Prince Turki Road, Al Khobar, Saudi Arabia',
    email: globalSettings.email || 'rkinfinity.official@gmail.com',
    phone: globalSettings.phone || '+966 55 123 4567',
