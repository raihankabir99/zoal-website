  ...
  return (
    <div className="space-y-6 text-left animate-fade-in font-sans">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-white/5 pb-4 gap-4">
        <div>
          <span className="text-[9px] tracking-[0.4em] text-gold-pure uppercase font-mono block mb-1">BRAND PORTFOLIO</span>
          <h2 className="text-xl font-bold tracking-widest font-display uppercase text-white flex items-center gap-2">
            <Tag className="w-5 h-5 text-gold-pure" /> BRAND MANAGEMENT
          </h2>
        </div>
        <div className="flex flex-wrap gap-2">
          ...
          >
            <Upload className="w-3.5 h-3.5" /> Import Brands
          </button>
          <button 
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { label: 'Total Brands', value: stats.total, sub: 'Active Brands', color: 'text-white' },
          { label: 'Featured Brands', value: stats.featured, sub: 'Shown on Homepage', color: 'text-gold-pure' },
          { label: 'Hidden / Drafts', value: stats.hidden, sub: 'Not Published', color: 'text-zinc-500' },
          { label: 'Archived records', value: stats.archived, sub: 'Archived', color: 'text-rose-500' },
        ].map((st, idx) => (
      ...
      <div className="bg-zinc-950 p-4 border border-white/5 rounded-xs space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
          ...
          <div className="md:col-span-1 space-y-1">
            <label className="text-[8.5px] font-mono uppercase text-zinc-500">Search Brands</label>
          ...
          <div className="space-y-1">
            <label className="text-[8.5px] font-mono uppercase text-zinc-500">Brand Status</label>
            <select
              value={statusFilter}
          ...
          {/* Country Filter */}
          <div className="space-y-1">
            <label className="text-[8.5px] font-mono uppercase text-zinc-500">Country</label>
            <select
              value={countryFilter}
          ...
          {/* Exhibition Filter */}
          <div className="space-y-1">
            <label className="text-[8.5px] font-mono uppercase text-zinc-500">Homepage Featured</label>
            <select
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center pt-2 border-t border-white/5 gap-3">
          <div className="flex items-center gap-2">
            <span className="text-[8.5px] font-mono text-zinc-500 uppercase">Sort by:</span>
            <button 
            ...
            >
              Total Products <ArrowUpDown className="w-3 h-3" />
            </button>
            <button 
          ...
          <div className="text-[9.5px] font-mono text-zinc-500">
            Showing <code className="text-white font-bold">{filteredBrands.length}</code> of {brands.length} brands
          </div>
        </div>
      </div>
          ...
          <div className="fixed inset-0 z-50 overflow-hidden flex justify-end font-sans">
            ...
            >
              ...
              <div className="p-5 border-b border-white/10 flex justify-between items-center bg-black">
                <div>
                  <span className="text-[8.5px] font-mono text-gold-pure uppercase tracking-widest block mb-0.5">Brand Directory List</span>
