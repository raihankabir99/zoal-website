    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-6 sm:mb-16">
          ...
          <div className="w-12 h-[1px] bg-gold-pure mx-auto mb-3 sm:mb-5" />
          <motion.p 
            initial={{ opacity: 0, y: 15 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="md:col-span-8 space-y-3.5 sm:space-y-6 md:space-y-8 print:w-full">
            ...
            >
              <div className={`p-2.5 sm:p-6 md:p-8 bg-[#050505]/40 backdrop-blur-md border rounded-sm transition-all duration-500 relative overflow-hidden shadow-2xl ${
                ...
                <div 
                  ...
                  onClick={() => {
                    setExpandedSections(prev => ({
                      ...prev,
                      'shipping-coverage': !prev['shipping-coverage']
                    }));
                  }}
                  onKeyDown={(e) => {
                  ...
                  className={`flex items-center justify-between gap-1.5 sm:gap-3 pb-2.5 sm:pb-4 border-b border-white/5 cursor-pointer select-none group/hdr focus:outline-none focus-visible:ring-1 focus-visible:ring-gold-pure/50 ${
                    expandedSections['shipping-coverage'] ? 'mb-3.5 sm:mb-6' : 'mb-0'
                  }`}
                >
                  <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
                    <div className="w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center rounded-full bg-gold-pure/5 text-gold-pure border border-gold-pure/10 shrink-0">
                      <MapPin className="w-3.5 h-3.5 sm:w-4.5 sm:h-4.5 shrink-0" />
                    </div>
                    <h2 className={`text-[11.5px] sm:text-sm md:text-base font-display uppercase tracking-wider sm:tracking-widest font-semibold leading-tight flex-1 min-w-0 transition-colors duration-500 ${
                      activeSectionId === 'shipping-coverage' ? 'text-gold-pure' : 'text-white group-hover/hdr:text-gold-pure'
                    }`}>
                      {isAr ? '1. التغطية ومناطق التوصيل' : '1. Shipping Coverage'}
                    </h2>
                  </div>
                  <div className="flex items-center gap-1 sm:gap-1.5 shrink-0 print:hidden">
                    <button onClick={(e) => copySectionLink('shipping-coverage', e)} className="p-1 sm:p-1.5 rounded-sm hover:bg-white/5 text-zinc-500 hover:text-gold-pure transition-colors relative group print:hidden cursor-pointer shrink-0">
                      {copiedId === 'shipping-coverage' ? <Check className="w-3.5 h-3.5 text-emerald-500" /> : <Copy className="w-3.5 h-3.5" />}
                    </button>
                    <motion.div
                      animate={{ rotate: expandedSections['shipping-coverage'] ? 180 : 0 }}
                      transition={{ duration: 0.2 }}
                ...
                <AnimatePresence initial={false}>
                  {expandedSections['shipping-coverage'] && (
                    <motion.div
              ...
              <div className={`p-2.5 sm:p-6 md:p-8 bg-[#050505]/40 backdrop-blur-md border rounded-sm transition-all duration-500 relative overflow-hidden shadow-2xl ${
                ...
                <div 
                  ...
                  onClick={() => {
                    setExpandedSections(prev => ({
                      ...prev,
                      'delivery-options': !prev['delivery-options']
                    }));
                  }}
                  onKeyDown={(e) => {
                    if (e.key === 'Enter' || e.key === ' ') {
                  ...
                  className={`flex items-center justify-between gap-1.5 sm:gap-3 pb-2.5 sm:pb-4 border-b border-white/5 cursor-pointer select-none group/hdr focus:outline-none focus-visible:ring-1 focus-visible:ring-gold-pure/50 ${
                    expandedSections['delivery-options'] ? 'mb-3.5 sm:mb-6' : 'mb-0'
                  }`}
                >
                  <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
                    <div className="w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center rounded-full bg-gold-pure/5 text-gold-pure border border-gold-pure/10 shrink-0">
                      <Truck className="w-3.5 h-3.5 sm:w-4.5 sm:h-4.5 shrink-0" />
                    </div>
                    <h2 className={`text-[11.5px] sm:text-sm md:text-base font-display uppercase tracking-wider sm:tracking-widest font-semibold leading-tight flex-1 min-w-0 transition-colors duration-500 ${
                      activeSectionId === 'delivery-options' ? 'text-gold-pure' : 'text-white group-hover/hdr:text-gold-pure'
                    }`}>
                      {isAr ? '2. خيارات التوصيل الفاخرة' : '2. Premium Delivery Options'}
                    </h2>
                  </div>
                  <div className="flex items-center gap-1 sm:gap-1.5 shrink-0 print:hidden">
                    <button onClick={(e) => copySectionLink('delivery-options', e)} className="p-1 sm:p-1.5 rounded-sm hover:bg-white/5 text-zinc-500 hover:text-gold-pure transition-colors relative group print:hidden cursor-pointer shrink-0">
                      {copiedId === 'delivery-options' ? <Check className="w-3.5 h-3.5 text-emerald-500" /> : <Copy className="w-3.5 h-3.5" />}
                    </button>
                    <motion.div
                      animate={{ rotate: expandedSections['delivery-options'] ? 180 : 0 }}
                      transition={{ duration: 0.2 }}
                      className="text-zinc-500 group-hover/hdr:text-gold-pure transition-colors p-0.5 sm:p-1 shrink-0"
                    >
                      <ChevronDown className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                ...
                <AnimatePresence initial={false}>
                  {expandedSections['delivery-options'] && (
                    <motion.div
                      initial={{ opacity: 0, height: 0 }}
                      animate={{ opacity: 1, height: 'auto' }}
                      exit={{ opacity: 0, height: 0 }}
              ...
              <div className={`p-2.5 sm:p-6 md:p-8 bg-[#050505]/40 backdrop-blur-md border rounded-sm transition-all duration-500 relative overflow-hidden shadow-2xl ${
                ...
                <div 
                  ...
                  onClick={() => {
                    setExpandedSections(prev => ({
                      ...prev,
                      'shipping-charges': !prev['shipping-charges']
                    }));
                  }}
                  onKeyDown={(e) => {
                    if (e.key === 'Enter' || e.key === ' ') {
                  ...
                  className={`flex items-center justify-between gap-1.5 sm:gap-3 pb-2.5 sm:pb-4 border-b border-white/5 cursor-pointer select-none group/hdr focus:outline-none focus-visible:ring-1 focus-visible:ring-gold-pure/50 ${
                    expandedSections['shipping-charges'] ? 'mb-3.5 sm:mb-6' : 'mb-0'
                  }`}
                >
                  <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
                    <div className="w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center rounded-full bg-gold-pure/5 text-gold-pure border border-gold-pure/10 shrink-0">
                      <DollarSign className="w-3.5 h-3.5 sm:w-4.5 sm:h-4.5 shrink-0" />
                    </div>
                    <h2 className={`text-[11.5px] sm:text-sm md:text-base font-display uppercase tracking-wider sm:tracking-widest font-semibold leading-tight flex-1 min-w-0 transition-colors duration-500 ${
                      activeSectionId === 'shipping-charges' ? 'text-gold-pure' : 'text-white group-hover/hdr:text-gold-pure'
                    }`}>
                      {isAr ? '3. رسوم الشحن والتوصيل' : '3. Shipping Charges'}
                    </h2>
                  </div>
                  <div className="flex items-center gap-1 sm:gap-1.5 shrink-0 print:hidden">
                    <button onClick={(e) => copySectionLink('shipping-charges', e)} className="p-1 sm:p-1.5 rounded-sm hover:bg-white/5 text-zinc-500 hover:text-gold-pure transition-colors relative group print:hidden cursor-pointer shrink-0">
                      {copiedId === 'shipping-charges' ? <Check className="w-3.5 h-3.5 text-emerald-500" /> : <Copy className="w-3.5 h-3.5" />}
                    </button>
                    <motion.div
                      animate={{ rotate: expandedSections['shipping-charges'] ? 180 : 0 }}
                      transition={{ duration: 0.2 }}
                      className="text-zinc-500 group-hover/hdr:text-gold-pure transition-colors p-0.5 sm:p-1 shrink-0"
                    >
                      <ChevronDown className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                ...
                <AnimatePresence initial={false}>
                  {expandedSections['shipping-charges'] && (
                    <motion.div
                      initial={{ opacity: 0, height: 0 }}
                      animate={{ opacity: 1, height: 'auto' }}
                      exit={{ opacity: 0, height: 0 }}
              ...
              <div className={`p-2.5 sm:p-6 md:p-8 bg-[#050505]/40 backdrop-blur-md border rounded-sm transition-all duration-500 relative overflow-hidden shadow-2xl ${
                ...
                <div 
                  ...
                  onClick={() => {
                    setExpandedSections(prev => ({
                      ...prev,
                      'order-processing': !prev['order-processing']
                    }));
                  }}
                  onKeyDown={(e) => {
                    if (e.key === 'Enter' || e.key === ' ') {
                  ...
                  className={`flex items-center justify-between gap-1.5 sm:gap-3 pb-2.5 sm:pb-4 border-b border-white/5 cursor-pointer select-none group/hdr focus:outline-none focus-visible:ring-1 focus-visible:ring-gold-pure/50 ${
                    expandedSections['order-processing'] ? 'mb-3.5 sm:mb-6' : 'mb-0'
                  }`}
                >
                  <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
                    <div className="w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center rounded-full bg-gold-pure/5 text-gold-pure border border-gold-pure/10 shrink-0">
                    ...
                    <h2 className={`text-[11.5px] sm:text-sm md:text-base font-display uppercase tracking-wider sm:tracking-widest font-semibold leading-tight flex-1 min-w-0 transition-colors duration-500 ${
                      activeSectionId === 'order-processing' ? 'text-gold-pure' : 'text-white group-hover/hdr:text-gold-pure'
                    }`}>
                      {isAr ? '4. معالجة وتجهيز الطلبات' : '4. Order Processing'}
                    </h2>
                  </div>
                  <div className="flex items-center gap-1 sm:gap-1.5 shrink-0 print:hidden">
                    <button onClick={(e) => copySectionLink('order-processing', e)} className="p-1 sm:p-1.5 rounded-sm hover:bg-white/5 text-zinc-500 hover:text-gold-pure transition-colors relative group print:hidden cursor-pointer shrink-0">
                      {copiedId === 'order-processing' ? <Check className="w-3.5 h-3.5 text-emerald-500" /> : <Copy className="w-3.5 h-3.5" />}
                    </button>
                    <motion.div
                      animate={{ rotate: expandedSections['order-processing'] ? 180 : 0 }}
                      transition={{ duration: 0.2 }}
                      className="text-zinc-500 group-hover/hdr:text-gold-pure transition-colors p-0.5 sm:p-1 shrink-0"
                    >
                      <ChevronDown className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                ...
                <AnimatePresence initial={false}>
                  {expandedSections['order-processing'] && (
                    <motion.div
                      initial={{ opacity: 0, height: 0 }}
                      animate={{ opacity: 1, height: 'auto' }}
                      exit={{ opacity: 0, height: 0 }}
              ...
              <div className={`p-2.5 sm:p-6 md:p-8 bg-[#050505]/40 backdrop-blur-md border rounded-sm transition-all duration-500 relative overflow-hidden shadow-2xl ${
                ...
                <div 
                  ...
                  onClick={() => {
                    setExpandedSections(prev => ({
                      ...prev,
                      'dispatch-time': !prev['dispatch-time']
                    }));
                  }}
                  onKeyDown={(e) => {
                    if (e.key === 'Enter' || e.key === ' ') {
                  ...
                  className={`flex items-center justify-between gap-1.5 sm:gap-3 pb-2.5 sm:pb-4 border-b border-white/5 cursor-pointer select-none group/hdr focus:outline-none focus-visible:ring-1 focus-visible:ring-gold-pure/50 ${
                    expandedSections['dispatch-time'] ? 'mb-3.5 sm:mb-6' : 'mb-0'
                  }`}
                >
                  <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
                    <div className="w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center rounded-full bg-gold-pure/5 text-gold-pure border border-gold-pure/10 shrink-0">
                      <Send className="w-3.5 h-3.5 sm:w-4.5 sm:h-4.5 shrink-0" />
                    </div>
                    <h2 className={`text-[11.5px] sm:text-sm md:text-base font-display uppercase tracking-wider sm:tracking-widest font-semibold leading-tight flex-1 min-w-0 transition-colors duration-500 ${
                      activeSectionId === 'dispatch-time' ? 'text-gold-pure' : 'text-white group-hover/hdr:text-gold-pure'
                    }`}>
                      {isAr ? '5. وقت تسليم الشحنات للمندوب' : '5. Dispatch Protocol'}
                    </h2>
                  </div>
                  <div className="flex items-center gap-1 sm:gap-1.5 shrink-0 print:hidden">
                    <button onClick={(e) => copySectionLink('dispatch-time', e)} className="p-1 sm:p-1.5 rounded-sm hover:bg-white/5 text-zinc-500 hover:text-gold-pure transition-colors relative group print:hidden cursor-pointer shrink-0">
                      {copiedId === 'dispatch-time' ? <Check className="w-3.5 h-3.5 text-emerald-500" /> : <Copy className="w-3.5 h-3.5" />}
                    </button>
                    <motion.div
                      animate={{ rotate: expandedSections['dispatch-time'] ? 180 : 0 }}
                      transition={{ duration: 0.2 }}
                      className="text-zinc-500 group-hover/hdr:text-gold-pure transition-colors p-0.5 sm:p-1 shrink-0"
                    >
                      <ChevronDown className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                ...
                <AnimatePresence initial={false}>
                  {expandedSections['dispatch-time'] && (
                    <motion.div
                      initial={{ opacity: 0, height: 0 }}
                      animate={{ opacity: 1, height: 'auto' }}
                      exit={{ opacity: 0, height: 0 }}
                    ...
                    >
                      <div className="space-y-4 text-xs sm:text-[13px] text-zinc-400 font-sans leading-relaxed">
                        ...
                        <div className="space-y-2 pt-2">
                          ...
                          <ul className="space-y-2 text-[11.5px] ps-4 border-s border-white/5 border-gold-pure/20">
              ...
              <div className={`p-2.5 sm:p-6 md:p-8 bg-[#050505]/40 backdrop-blur-md border rounded-sm transition-all duration-500 relative overflow-hidden shadow-2xl ${
                ...
                <div 
                  ...
                  onClick={() => {
                    setExpandedSections(prev => ({
                      ...prev,
                      'estimated-delivery-time': !prev['estimated-delivery-time']
                    }));
                  }}
                  onKeyDown={(e) => {
                    if (e.key === 'Enter' || e.key === ' ') {
                  ...
                  className={`flex items-center justify-between gap-1.5 sm:gap-3 pb-2.5 sm:pb-4 border-b border-white/5 cursor-pointer select-none group/hdr focus:outline-none focus-visible:ring-1 focus-visible:ring-gold-pure/50 ${
                    expandedSections['estimated-delivery-time'] ? 'mb-3.5 sm:mb-6' : 'mb-0'
                  }`}
                >
                  <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
                    <div className="w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center rounded-full bg-gold-pure/5 text-gold-pure border border-gold-pure/10 shrink-0">
                      <Table className="w-3.5 h-3.5 sm:w-4.5 sm:h-4.5 shrink-0" />
                    </div>
                    <h2 className={`text-[11.5px] sm:text-sm md:text-base font-display uppercase tracking-wider sm:tracking-widest font-semibold leading-tight flex-1 min-w-0 transition-colors duration-500 ${
                      activeSectionId === 'estimated-delivery-time' ? 'text-gold-pure' : 'text-white group-hover/hdr:text-gold-pure'
                    }`}>
                      {isAr ? '6. الفترات الزمنية المتوقعة للوصول' : '6. Estimated Delivery Time'}
                    </h2>
                  </div>
                  <div className="flex items-center gap-1 sm:gap-1.5 shrink-0 print:hidden">
                    <button onClick={(e) => copySectionLink('estimated-delivery-time', e)} className="p-1 sm:p-1.5 rounded-sm hover:bg-white/5 text-zinc-500 hover:text-gold-pure transition-colors relative group print:hidden cursor-pointer shrink-0">
                      {copiedId === 'estimated-delivery-time' ? <Check className="w-3.5 h-3.5 text-emerald-500" /> : <Copy className="w-3.5 h-3.5" />}
                    </button>
                    <motion.div
                      animate={{ rotate: expandedSections['estimated-delivery-time'] ? 180 : 0 }}
                      transition={{ duration: 0.2 }}
                      className="text-zinc-500 group-hover/hdr:text-gold-pure transition-colors p-0.5 sm:p-1 shrink-0"
                    >
                      <ChevronDown className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                ...
                <AnimatePresence initial={false}>
                  {expandedSections['estimated-delivery-time'] && (
                    <motion.div
                      initial={{ opacity: 0, height: 0 }}
                      animate={{ opacity: 1, height: 'auto' }}
                      exit={{ opacity: 0, height: 0 }}
              ...
              <div className={`p-2.5 sm:p-6 md:p-8 bg-[#050505]/40 backdrop-blur-md border rounded-sm transition-all duration-500 relative overflow-hidden shadow-2xl ${
                ...
                <div 
                  ...
                  onClick={() => {
                    setExpandedSections(prev => ({
                      ...prev,
                      'delivery-delays': !prev['delivery-delays']
                    }));
                  }}
                  onKeyDown={(e) => {
                    if (e.key === 'Enter' || e.key === ' ') {
                  ...
                  className={`flex items-center justify-between gap-1.5 sm:gap-3 pb-2.5 sm:pb-4 border-b border-white/5 cursor-pointer select-none group/hdr focus:outline-none focus-visible:ring-1 focus-visible:ring-gold-pure/50 ${
                    expandedSections['delivery-delays'] ? 'mb-3.5 sm:mb-6' : 'mb-0'
                  }`}
                >
                  <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
                    <div className="w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center rounded-full bg-gold-pure/5 text-gold-pure border border-gold-pure/10 shrink-0">
                    ...
                    <h2 className={`text-[11.5px] sm:text-sm md:text-base font-display uppercase tracking-wider sm:tracking-widest font-semibold leading-tight flex-1 min-w-0 transition-colors duration-500 ${
                      activeSectionId === 'delivery-delays' ? 'text-gold-pure' : 'text-white group-hover/hdr:text-gold-pure'
                    }`}>
                      {isAr ? '7. مسببات التأخير الاستثنائية' : '7. Delivery Delays'}
                    </h2>
                  </div>
                  <div className="flex items-center gap-1 sm:gap-1.5 shrink-0 print:hidden">
                    <button onClick={(e) => copySectionLink('delivery-delays', e)} className="p-1 sm:p-1.5 rounded-sm hover:bg-white/5 text-zinc-500 hover:text-gold-pure transition-colors relative group print:hidden cursor-pointer shrink-0">
                      {copiedId === 'delivery-delays' ? <Check className="w-3.5 h-3.5 text-emerald-500" /> : <Copy className="w-3.5 h-3.5" />}
                    </button>
                    <motion.div
                      animate={{ rotate: expandedSections['delivery-delays'] ? 180 : 0 }}
                      transition={{ duration: 0.2 }}
                      className="text-zinc-500 group-hover/hdr:text-gold-pure transition-colors p-0.5 sm:p-1 shrink-0"
                    >
                      <ChevronDown className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                ...
                <AnimatePresence initial={false}>
                  {expandedSections['delivery-delays'] && (
                    <motion.div
                      initial={{ opacity: 0, height: 0 }}
                      animate={{ opacity: 1, height: 'auto' }}
                      exit={{ opacity: 0, height: 0 }}
              ...
              <div className={`p-2.5 sm:p-6 md:p-8 bg-[#050505]/40 backdrop-blur-md border rounded-sm transition-all duration-500 relative overflow-hidden shadow-2xl ${
                ...
                <div 
                  ...
                  onClick={() => {
                    setExpandedSections(prev => ({
                      ...prev,
                      'delivery-address': !prev['delivery-address']
                    }));
                  }}
                  onKeyDown={(e) => {
                    if (e.key === 'Enter' || e.key === ' ') {
                  ...
                  className={`flex items-center justify-between gap-1.5 sm:gap-3 pb-2.5 sm:pb-4 border-b border-white/5 cursor-pointer select-none group/hdr focus:outline-none focus-visible:ring-1 focus-visible:ring-gold-pure/50 ${
                    expandedSections['delivery-address'] ? 'mb-3.5 sm:mb-6' : 'mb-0'
                  }`}
                >
                  <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
                    <div className="w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center rounded-full bg-gold-pure/5 text-gold-pure border border-gold-pure/10 shrink-0">
                      <Navigation className="w-3.5 h-3.5 sm:w-4.5 sm:h-4.5 shrink-0" />
                    </div>
                    <h2 className={`text-[11.5px] sm:text-sm md:text-base font-display uppercase tracking-wider sm:tracking-widest font-semibold leading-tight flex-1 min-w-0 transition-colors duration-500 ${
                      activeSectionId === 'delivery-address' ? 'text-gold-pure' : 'text-white group-hover/hdr:text-gold-pure'
                    }`}>
                      {isAr ? '8. دقة وصحة عنوان التوصيل' : '8. Delivery Address Accuracy'}
                    </h2>
                  </div>
                  <div className="flex items-center gap-1 sm:gap-1.5 shrink-0 print:hidden">
                    <button onClick={(e) => copySectionLink('delivery-address', e)} className="p-1 sm:p-1.5 rounded-sm hover:bg-white/5 text-zinc-500 hover:text-gold-pure transition-colors relative group print:hidden cursor-pointer shrink-0">
                      {copiedId === 'delivery-address' ? <Check className="w-3.5 h-3.5 text-emerald-500" /> : <Copy className="w-3.5 h-3.5" />}
                    </button>
                    <motion.div
                      animate={{ rotate: expandedSections['delivery-address'] ? 180 : 0 }}
                      transition={{ duration: 0.2 }}
                      className="text-zinc-500 group-hover/hdr:text-gold-pure transition-colors p-0.5 sm:p-1 shrink-0"
                    >
                      <ChevronDown className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                ...
                <AnimatePresence initial={false}>
                  {expandedSections['delivery-address'] && (
                    <motion.div
                      initial={{ opacity: 0, height: 0 }}
                      animate={{ opacity: 1, height: 'auto' }}
                      exit={{ opacity: 0, height: 0 }}
              ...
              <div className={`p-2.5 sm:p-6 md:p-8 bg-[#050505]/40 backdrop-blur-md border rounded-sm transition-all duration-500 relative overflow-hidden shadow-2xl ${
                ...
                <div 
                  ...
                  onClick={() => {
                    setExpandedSections(prev => ({
                      ...prev,
                      'order-tracking': !prev['order-tracking']
                    }));
                  }}
                  onKeyDown={(e) => {
                    if (e.key === 'Enter' || e.key === ' ') {
                  ...
                  className={`flex items-center justify-between gap-1.5 sm:gap-3 pb-2.5 sm:pb-4 border-b border-white/5 cursor-pointer select-none group/hdr focus:outline-none focus-visible:ring-1 focus-visible:ring-gold-pure/50 ${
                    expandedSections['order-tracking'] ? 'mb-3.5 sm:mb-6' : 'mb-0'
                  }`}
                >
                  <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
                    <div className="w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center rounded-full bg-gold-pure/5 text-gold-pure border border-gold-pure/10 shrink-0">
                      <Search className="w-3.5 h-3.5 sm:w-4.5 sm:h-4.5 shrink-0" />
                    </div>
                    <h2 className={`text-[11.5px] sm:text-sm md:text-base font-display uppercase tracking-wider sm:tracking-widest font-semibold leading-tight flex-1 min-w-0 transition-colors duration-500 ${
                      activeSectionId === 'order-tracking' ? 'text-gold-pure' : 'text-white group-hover/hdr:text-gold-pure'
                    }`}>
                      {isAr ? '9. تتبع الشحنات والطلبات' : '9. Order Tracking'}
                    </h2>
                  </div>
                  <div className="flex items-center gap-1 sm:gap-1.5 shrink-0 print:hidden">
                    <button onClick={(e) => copySectionLink('order-tracking', e)} className="p-1 sm:p-1.5 rounded-sm hover:bg-white/5 text-zinc-500 hover:text-gold-pure transition-colors relative group print:hidden cursor-pointer shrink-0">
                      {copiedId === 'order-tracking' ? <Check className="w-3.5 h-3.5 text-emerald-500" /> : <Copy className="w-3.5 h-3.5" />}
                    </button>
                    <motion.div
                      animate={{ rotate: expandedSections['order-tracking'] ? 180 : 0 }}
                      transition={{ duration: 0.2 }}
                      className="text-zinc-500 group-hover/hdr:text-gold-pure transition-colors p-0.5 sm:p-1 shrink-0"
                    >
                      <ChevronDown className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                ...
                <AnimatePresence initial={false}>
                  {expandedSections['order-tracking'] && (
                    <motion.div
                      initial={{ opacity: 0, height: 0 }}
                      animate={{ opacity: 1, height: 'auto' }}
                      exit={{ opacity: 0, height: 0 }}
              ...
              <div className={`p-2.5 sm:p-6 md:p-8 bg-[#050505]/40 backdrop-blur-md border rounded-sm transition-all duration-500 relative overflow-hidden shadow-2xl ${
                ...
                <div 
                  ...
                  onClick={() => {
                    setExpandedSections(prev => ({
                      ...prev,
                      'contact-support': !prev['contact-support']
                    }));
                  }}
                  onKeyDown={(e) => {
                    if (e.key === 'Enter' || e.key === ' ') {
                  ...
                  className={`flex items-center justify-between gap-1.5 sm:gap-3 pb-2.5 sm:pb-4 border-b border-white/5 cursor-pointer select-none group/hdr focus:outline-none focus-visible:ring-1 focus-visible:ring-gold-pure/50 ${
                    expandedSections['contact-support'] ? 'mb-3.5 sm:mb-6' : 'mb-0'
                  }`}
                >
                  <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
                    <div className="w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center rounded-full bg-gold-pure/5 text-gold-pure border border-gold-pure/10 shrink-0">
                      <MessageSquare className="w-3.5 h-3.5 sm:w-4.5 sm:h-4.5 shrink-0" />
                    </div>
                    <h2 className={`text-[11.5px] sm:text-sm md:text-base font-display uppercase tracking-wider sm:tracking-widest font-semibold leading-tight flex-1 min-w-0 transition-colors duration-500 ${
                      activeSectionId === 'contact-support' ? 'text-gold-pure' : 'text-white group-hover/hdr:text-gold-pure'
                    }`}>
                      {isAr ? '10. قنوات الدعم والمساعدة' : '10. Contact Support'}
                    </h2>
                  </div>
                  <div className="flex items-center gap-1 sm:gap-1.5 shrink-0 print:hidden">
                    <button onClick={(e) => copySectionLink('contact-support', e)} className="p-1 sm:p-1.5 rounded-sm hover:bg-white/5 text-zinc-500 hover:text-gold-pure transition-colors relative group print:hidden cursor-pointer shrink-0">
                      {copiedId === 'contact-support' ? <Check className="w-3.5 h-3.5 text-emerald-500" /> : <Copy className="w-3.5 h-3.5" />}
                    </button>
                    <motion.div
                      animate={{ rotate: expandedSections['contact-support'] ? 180 : 0 }}
                      transition={{ duration: 0.2 }}
                      className="text-zinc-500 group-hover/hdr:text-gold-pure transition-colors p-0.5 sm:p-1 shrink-0"
                    >
                      <ChevronDown className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                ...
                <AnimatePresence initial={false}>
                  {expandedSections['contact-support'] && (
                    <motion.div
                      initial={{ opacity: 0, height: 0 }}
                      animate={{ opacity: 1, height: 'auto' }}
                      exit={{ opacity: 0, height: 0 }}
