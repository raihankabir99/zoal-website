        ...
        >
          <div className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-gold-pure/5 border border-gold-pure/15">
            ...
            <span className="text-[9px] uppercase tracking-[0.3em] font-display font-semibold text-gold-pure">
              {isAr ? 'بروتوكول الشحن الفاخر' : 'Luxury Concierge Logistics'}
            </span>
          </div>
        </motion.div>
                ...
                <div className="space-y-4 text-xs sm:text-[13px] text-zinc-400 font-sans leading-relaxed">
                  ...
                  <p className="pt-2 text-[11px] text-zinc-500 italic">
                    {isAr 
                      ...
                      : '* Additional remote cities and local governorates within KSA are constantly added and reviewed to fulfill our esteemed patrons requests.'
                    }
                  </p>
                </div>
              </div>
                  ...
                  <div className="p-4 border border-[#D4AF37]/25 bg-gold-pure/5 rounded-xs flex items-center gap-3.5">
                    ...
                    <div>
                      <span className="text-xs text-white block font-semibold uppercase tracking-wider">
                        {isAr ? `خدمة الشحن المجاني` : `Complimentary Sovereign Shipping`}
                      </span>
                  ...
                  <div className="border border-white/5 bg-black/50 p-4 rounded-xs space-y-3">
                    ...
                    <div className="text-[11px] text-zinc-500 pl-6 rtl:pl-0 rtl:pr-6 leading-relaxed">
                      {isAr 
                        ...
                        : 'Processing comprises: strict measurement auditing (for bespoke thobes), fresh artisanal roasting, and climate-controlled secure vacuum sealing.'
                      }
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4 text-xs sm:text-[13px] text-zinc-400 font-sans leading-relaxed">
                  <p>
                    {isAr 
                      ...
                      : 'As soon as your luxury box passes quality verification, it is formally logged and handed over to our high-priority logistics partners for dispatch. Patrons are notified instantly.'
                    }
                  </p>
                ...
                <div className="space-y-4 text-xs sm:text-[13px] text-zinc-400 font-sans leading-relaxed">
                  ...
                  <p>
                    {isAr 
                      ...
                      : 'Under any anomalous delay window, the ZOAL Patron Support Suite guarantees active communication to provide real-time updates and helpful alternatives.'
                    }
                  </p>
                </div>
              </div>
                ...
                <div className="space-y-4 text-xs sm:text-[13px] text-zinc-400 font-sans leading-relaxed">
                  <p>
                    {isAr 
                      ...
                      : 'Patrons are strictly responsible for providing complete, up-to-date, and precise geographic coordinates at checkout. An accurate address avoids delivery detours.'
                    }
                  </p>
                ...
                <div className="space-y-4 text-xs sm:text-[13px] text-zinc-400 font-sans leading-relaxed">
                  <p>
                    {isAr 
                      ...
                      : 'Patrons can maintain total situational awareness over their packages from preparation to destination utilizing our dynamic tools:'
                    }
                  </p>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="p-4 bg-zinc-950/60 border border-white/5 rounded-xs space-y-1">
                      <span className="text-[10px] font-mono uppercase tracking-wider text-white block">
                        {isAr ? 'تتبع عبر الحساب الشخصي' : 'Patron Account Portal'}
                      </span>
                      <p className="text-[11px] text-zinc-400 leading-normal">
                        {isAr 
                          ? 'يمكنك التوجه لصفحة حسابك الشخصي لمتابعة مراحل تجهيز ثوبك المخصص أو البن المختار.'
                          : 'Log in to your private patron dashboard to inspect thobe cutting, roasting cycles, or dispatch times.'
                        }
                      </p>
                    </div>
                ...
                <div className="space-y-6 text-xs sm:text-[13px] text-zinc-400 font-sans leading-relaxed">
                  <p>
                    {isAr 
                      ...
                      : 'Require assistance with an active shipment? Need to coordinate delivery hours with our dispatcher? The ZOAL Patron Support Suite is fully available 24/7 to cater to your requests:'
                    }
                  </p>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    >
                      ...
                      <div>
                        <span className="text-[10px] text-zinc-500 font-mono uppercase tracking-widest block">{isAr ? 'دعم الواتساب المباشر' : 'Concierge WhatsApp'}</span>
                    ...
                    <div className="p-4 rounded-xs border border-white/5 bg-black/40 flex items-start gap-3.5 sm:col-span-2">
                      ...
                      <div className="space-y-1">
                        <span className="text-[10px] text-zinc-500 font-mono uppercase tracking-widest block">{isAr ? 'خدمة الضيافة ومواعيد الدعم' : 'Concierge Availability'}</span>
