          ...
          <div className="hidden lg:flex items-center space-x-6 rtl:space-x-reverse">
            ...
            <div className="relative group/nav-profile flex items-center">
              <button
                ...
                title={currentUser ? `Portal: ${currentUser.name || 'User'}` : 'Login Privilege'}
              >
                  ...
                  <div className="flex flex-col gap-1">
                    {currentUser && (
                      <RoleGuard role="admin" userRole={(currentUser as any)?.role}>
                        <button
                          ...
                          className="w-full text-left py-2 px-2 text-[10px] uppercase tracking-wider text-amber-400 hover:text-white bg-amber-500/10 hover:bg-amber-500/25 rounded-xs transition-all cursor-pointer font-bold border border-amber-500/20 mb-1.5 flex items-center gap-2"
                        >
                    ...
                    <div className="grid grid-cols-5 gap-1 py-1 border-b border-white/5 mb-1 text-center">
                      {[
                        ...
                        { id: 'wishlist', label: t('nav.wishlist', { defaultValue: 'My Wishlist' }), icon: Heart },
                    ...
                    {[
                      { id: 'profile', name: 'My Profile', desc: 'Manage your personal information', icon: User },
                      { id: 'settings', name: 'Account Settings', desc: 'Language, notifications and preferences', icon: Settings },
                    ].map((item) => {
                      ...
                      return (
                        <button
                          ...
                          className="w-full text-left py-2 px-2.5 rounded-xs hover:bg-white/5 transition-all cursor-pointer group flex items-start gap-2.5"
                        >
