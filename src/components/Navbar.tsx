                  ...
                  <div className="flex flex-col gap-1">
                    {(currentUser as any).role === 'admin' && (
                      <button
                        ...
                        className="w-full text-left py-1.5 px-2 text-[9px] uppercase tracking-wider text-amber-400 hover:text-white bg-amber-500/10 hover:bg-amber-500/25 rounded-xs transition-all cursor-pointer font-bold border border-amber-500/20 mb-1.5 flex items-center gap-1.5"
                      >
