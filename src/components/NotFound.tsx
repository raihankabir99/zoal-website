...
export default function NotFound({ setCurrentPage, onProductSelect, setSelectedCategoryFilter }: NotFoundProps) {
  ...
  const localT = {
    ...
    searchPlaceholder: isAr ? 'ابحث عن منتجات فاخرة...' : 'Search premium collections...',
                        ...
                        searchResults.map((prod) => (
                          ...
                          >
                            <div className="relative w-10 h-10 rounded-xs overflow-hidden border border-white/5 bg-neutral-900 shrink-0">
                              <SafeImage product={prod} alt={prod.name} className="w-full h-full object-cover" />
                            </div>
                            ...
                            <span className="text-xs text-gold-pure font-sans whitespace-nowrap shrink-0 tabular-nums-fix">
              ...
              {recommendedProducts.map((prod) => (
                ...
                >
                  <div className="relative w-16 h-16 rounded-xs overflow-hidden border border-white/5 bg-neutral-900 shrink-0">
                    <SafeImage product={prod} alt={prod.name} className="w-full h-full object-cover group-hover:scale-110 duration-700 transition-transform" />
                  </div>
                  <div className="flex-grow min-w-0 flex flex-col justify-between">
                    ...
                    <span className="text-[11px] text-gold-pure font-mono font-bold tabular-nums-fix">
