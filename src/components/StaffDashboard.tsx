          ...
          <div className="flex items-center gap-1.5 text-[9px] uppercase tracking-[0.25em] text-zinc-500 font-mono">
            ...
            <span className="text-[#D4AF37] font-semibold">
              {staffSubTab === 'overview' ? 'Overview Dashboard' :
               staffSubTab === 'orders' ? (selectedStaffOrder ? 'Order Detail Drawer' : 'Orders Ledger') :
               staffSubTab === 'inventory' ? 'Inventory Manager' :
               staffSubTab === 'bespoke' ? 'Bespoke Catalog' :
               staffSubTab === 'customers' ? 'Customer Directory' :
               staffSubTab === 'alerts' ? 'Alerts Feed' :
               staffSubTab === 'profile' ? 'Profile & Settings' :
               staffSubTab === 'admin' ? 'Admin Sovereign Hub' : 'Workspace'}
            </span>
          </div>
        </div>
          ...
          <div className="relative group/staff select-none">
            <div className="flex items-center gap-2 p-1 px-2.5 bg-black hover:bg-zinc-900 border border-white/5 rounded-xs cursor-pointer duration-300">
              ...
              <span className="text-[9.5px] font-semibold text-zinc-300 uppercase tracking-wider truncate max-w-[90px] hidden sm:block">
                {currentUser ? currentUser.name.split(' ')[0] : 'Staff'}
              </span>
            </div>
            ...
            <div className="absolute right-0 top-full mt-1.5 w-44 bg-zinc-950 border border-white/5 rounded-sm shadow-xl opacity-0 pointer-events-none group-hover/staff:opacity-100 group-hover/staff:pointer-events-auto transition-all duration-200 z-50 p-1">
              <div className="p-1.5 border-b border-white/5 text-left mb-1">
                <p className="text-[10px] text-white font-semibold truncate mb-0.5">{currentUser?.name}</p>
              ...
              <button
                ...
                className="w-full text-left py-1 px-2 text-[9px] uppercase tracking-wider text-zinc-400 hover:text-[#D4AF37] hover:bg-white/5 rounded-xs transition-all"
              >
                Duty Settings
              </button>
              {userRole === 'admin' && (
                <button
                  ...
                  className="w-full text-left py-1 px-2 text-[9px] uppercase tracking-wider text-zinc-400 hover:text-[#D4AF37] hover:bg-white/5 rounded-xs transition-all font-semibold"
                >
                  Sovereign Settings
                </button>
              )}
      ...
      <div className="flex flex-col lg:flex-row gap-6 items-start relative">
        ...
        <div className="hidden lg:block w-64 shrink-0 bg-zinc-950 border border-white/5 rounded-sm p-4 space-y-1.5 font-sans">
          ...
          <div className="space-y-1">
            ...
            >
              <ClipboardList className="w-3.5 h-3.5 shrink-0" /> Orders Ledger
            </button>
            ...
            <button
              onClick={() => { setStaffSubTab('bespoke'); setSelectedStaffOrder(null); }}
              className={`w-full text-left py-2 px-3 text-[10.5px] uppercase tracking-wider font-display rounded-xs transition-all flex items-center gap-2.5 ${
                staffSubTab === 'bespoke' ? 'bg-[#D4AF37] text-black font-semibold shadow-md' : 'text-zinc-400 hover:text-white hover:bg-white/[0.02]'
              }`}
            >
              <Bookmark className="w-3.5 h-3.5 shrink-0" /> Bespoke Catalog
            </button>
            ...
            <>
              ...
              >
                ...
                <div className="flex-grow space-y-1 overflow-y-auto">
                  ...
                  >
                    <ClipboardList className="w-4 h-4" /> Orders Ledger
                  </button>
                  ...
                  <button
                    onClick={() => { setStaffSubTab('bespoke'); setStaffSidebarOpen(false); setSelectedStaffOrder(null); }}
                    className={`w-full text-left py-2 px-3 text-[11px] uppercase tracking-widest rounded-xs flex items-center gap-3 ${
                      staffSubTab === 'bespoke' ? 'bg-[#D4AF37] text-black font-bold' : 'text-zinc-400 hover:bg-white/[0.02]'
                    }`}
                  >
                    <Bookmark className="w-4 h-4" /> Bespoke Catalog
                  </button>
        ...
        <div className="flex-grow w-full space-y-6">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="bg-zinc-950 border border-white/5 p-4 rounded-sm relative overflow-hidden flex flex-col justify-between h-28">
                  ...
                  <span className="text-[9px] text-indigo-400 block font-mono">Bespoke custom thobe cuts</span>
                </div>
            ...
            <div className="space-y-6 font-sans">
              ...
              <div className="bg-zinc-950 border border-white/5 rounded-sm p-4 flex flex-col sm:flex-row items-center gap-4">
                ...
                <span className="text-[10px] text-zinc-500 ml-auto font-mono hidden md:block">
                  {orders.length} orders total ledger
                </span>
              </div>
                  ...
                  >
                    ...
                    <div className="pt-4 border-t border-white/5 flex flex-wrap items-center justify-between gap-3 text-xs font-display">
                      <div className="flex gap-2">
                        <button
                          onClick={() => {
                            alert(`Generating premium luxury dispatch sheet for order ${selectedStaffOrder.id}.\nReady to print to secure boutique thermal system.`);
                        ...
                        >
                          <FileText className="w-3.5 h-3.5 text-[#D4AF37]" /> Print Dispatch Sheet
                        </button>

                        <button
                          onClick={() => {
                            alert(`Downloading sovereign invoice PDF of order ${selectedStaffOrder.id}.\nSLA fulfillment check validated.`);
                            addStaffLog('Invoice Downloaded', `Downloaded PDF receipt for ${selectedStaffOrder.id}`);
                          }}
                          className="px-4 py-2 border border-white/10 hover:border-[#D4AF37]/35 text-zinc-300 hover:text-white rounded-xs transition-colors flex items-center gap-2 cursor-pointer"
                        >
              ...
              <div className="bg-[#060606] border border-white/5 rounded-sm p-5 space-y-4 text-left font-sans">
                <div className="border-b border-white/5 pb-3">
                  ...
                  <h3 className="text-white text-base font-semibold uppercase tracking-wider flex items-center gap-2">
                    <Bookmark className="w-4.5 h-4.5 text-[#D4AF37]" /> Patron Tailoring Customization Ledger
                  </h3>
                </div>

                <div className="divide-y divide-white/5 space-y-4">
                  {[
                    { id: 'ORD-7491', customerName: 'Raihan Kabir', product: 'Sovereign White Brocade Thobe', measures: 'Length: 58.5", Chest: 44", Shoulder: 18.2", Sleeve: 24.5"', status: 'Artisan Assembly Draft', date: '10 mins ago' },
                      ...
                      <div className="text-right self-start sm:self-center shrink-0">
                        ...
                        <button
                          onClick={() => {
                            ...
                            addStaffLog('Bespoke Advance', `Tailoring status advanced for ${bsp.id}`);
                          }}
          ...
          {staffSubTab === 'alerts' && (
            <div className="space-y-6">
              <div className="bg-[#060606] border border-white/5 rounded-sm p-5 space-y-4 text-left">
                <div className="flex items-center justify-between border-b border-white/5 pb-3">
                  <div>
                    <span className="text-[8px] font-mono uppercase tracking-[0.3em] text-[#D4AF37] block mb-0.5">Sovereign Alerts</span>
          ...
          {/* MODULE 7: PROFILE & SECURITY SETTINGS */}
          {staffSubTab === 'profile' && (
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-[#060606] border border-white/5 rounded-sm p-6 space-y-6 text-left font-sans">
                  <div className="border-b border-white/5 pb-3">
                    <span className="text-[8px] font-mono uppercase tracking-[0.3em] text-[#D4AF37] block mb-0.5">Sovereign Staff</span>
                    <h3 className="text-white text-base font-semibold uppercase tracking-wider">Staff Identity Profile</h3>
                  </div>

                  <div className="space-y-4 text-xs font-sans">
                    <div className="flex items-center gap-4 border-b border-white/5 pb-4">
                      <div className="w-14 h-14 rounded-full border border-[#D4AF37] bg-zinc-950 flex items-center justify-center text-3xl shadow-md">
                        💼
                      </div>
                      <div>
                        <p className="text-white text-base font-bold leading-tight">{currentUser?.name}</p>
                        <span className="text-[9px] font-mono text-[#D4AF37] tracking-widest uppercase">{userRole} credential privileges</span>
                      </div>
                    </div>

                    <div className="space-y-3 text-left">
                      <p className="text-zinc-400">Email: <span className="font-mono text-zinc-200 font-semibold">{currentUser?.email}</span></p>
                      <p className="text-zinc-400">Secure Pin Code: <span className="font-mono text-zinc-200">Boutique Active Standby</span></p>
                      <p className="text-zinc-400">IP Authorized Access: <span className="font-mono text-zinc-200">192.168.1.105 (Secure Local Branch)</span></p>
                    </div>
                    ...
                    <div className="p-4 border border-[#D4AF37]/15 bg-[#D4AF37]/5 rounded-xs space-y-3 mt-4">
                      <h4 className="text-[10px] text-[#D4AF37] font-mono uppercase tracking-wider border-b border-[#D4AF37]/10 pb-1.5 flex items-center gap-1.5">
                        <Clock className="w-3.5 h-3.5" /> Toggle Operational Duty Status
                      </h4>
                ...
                <div className="bg-[#060606] border border-white/5 rounded-sm p-6 space-y-5 text-left font-sans">
                  <div className="border-b border-white/5 pb-3">
                    <span className="text-[8px] font-mono uppercase tracking-[0.3em] text-[#D4AF37] block mb-0.5">Sovereign Security</span>
                    <h3 className="text-white text-base font-semibold uppercase tracking-wider flex items-center gap-2">
                      <Lock className="w-4.5 h-4.5 text-[#D4AF37]" /> Change Portal Password
                    </h3>
                  </div>

                  <div className="space-y-4 text-xs font-sans">
                    <div className="space-y-1.5">
                      <label className="text-[9px] text-zinc-400 uppercase tracking-widest block font-mono">Current Password Pin:</label>
                      <input 
                        type="password" 
                        placeholder="••••••••"
                    ...
                    <div className="space-y-1.5">
                      <label className="text-[9px] text-zinc-400 uppercase tracking-widest block font-mono">Establish New Password:</label>
                      <input 
                        type="password" 
                        placeholder="Type complex security key"
                    ...
                    <button
                      onClick={() => {
                        alert('Sovereign portal credentials updated successfully!\nActivity logged.');
          ...
          {staffSubTab === 'admin' && userRole === 'admin' && (
            <div className="space-y-8 animate-fade-in font-sans">
              ...
              {/* VIII. Supabase Sovereign Cloud Database Integration Hub */}
              <div className="bg-[#060606] border border-[#D4AF37]/20 rounded-sm p-6 space-y-6 text-left mt-8">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-white/5 pb-3 gap-2">
                  <div>
                    <h3 className="text-white text-xs font-display uppercase tracking-widest flex items-center gap-2">
