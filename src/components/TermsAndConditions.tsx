...
export default function TermsAndConditions() {
  ...
  useEffect(() => {
    ...
    const seoTitle = isAr 
      ? 'الشروط والأحكام | زول - الفخامة والأناقة العربية' 
      : 'Terms & Conditions | ZOAL - Timeless Luxury & Heritage';
    const seoDescription = isAr
      ? 'اقرأ الشروط والأحكام الخاصة بمنصة زول الفاخرة. توضح التزامات الشراء والدفع والتفصيل الآمن وضمان الملكية الفكرية وحقوق المستهلك في المملكة العربية السعودية.'
      : 'Review the ZOAL Terms & Conditions. Understand the billing, ordering, premium shipping policies, custom tailoring agreements, and consumer rights under Saudi regulations.';
        ...
        >
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-gold-pure/5 border border-gold-pure/15">
            ...
            <span className="text-[9px] uppercase tracking-[0.3em] font-display font-semibold text-gold-pure">
              {isAr ? 'الاتفاقية والالتزام الفاخر' : 'Luxury Sovereign Agreement'}
            </span>
          </div>
        </motion.div>
