    ...
    <footer dir="ltr" className="bg-black border-t border-white/5 py-16 text-xs text-zinc-500 font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
          ...
          <div className="md:col-span-2 space-y-4 text-zinc-400">
            ...
            <div className="p-3 border border-zinc-900 rounded-sm bg-zinc-950/20 text-[9.5px]">
              <span className="text-gold-pure font-bold block uppercase tracking-wider mb-0.5">Premium Service Delivery</span>
        ...
        <div className="pt-12 border-t border-white/5 mt-12 flex flex-wrap justify-center md:justify-between items-center text-zinc-500 text-[9px] tracking-[0.25em] uppercase gap-x-8 gap-y-4">
          <span>© {new Date().getFullYear()} {(settings?.businessName || 'ZOAL').split(' ')[0]}. All Rights Reserved.</span>
          ...
          <span className="text-[#D4AF37] hover:text-white transition-colors cursor-pointer" onClick={() => handleNavClick('about')}>Our Standard</span>
        </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/90 backdrop-blur-md">
          <div className="relative bg-zinc-950 border border-white/10 max-w-md w-full rounded-sm p-6 sm:p-8 shrink-0">
            ...
            <div className="text-center pb-4 border-b border-white/5 mb-4">
              ...
              <h3 className="text-white text-sm font-display uppercase tracking-widest font-semibold">{(settings?.businessName || 'ZOAL').split(' ')[0]} Careers</h3>
            ...
            {!appliedRoleMsg ? (
              ...
              <div className="text-center py-6 space-y-3">
                ...
                <p className="text-zinc-500 text-[10px] leading-relaxed max-w-xs mx-auto">
                  Greetings, <strong className="text-white">{applicantName}</strong>. Your luxury application for <strong className="text-white">{selectedRole}</strong> has been transmitted successfully to our career selection panel. A curation official will reach out shortly.
                </p>
                <button
                  onClick={() => {
                    setCareersModalOpen(false);
