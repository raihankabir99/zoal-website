...
const SEED_CRM_CUSTOMERS: CustomerCrmProfile[] = [
  {
    ...
    addresses: [
      ...
      },
      {
        ...
        type: 'Billing',
        isDefault: false,
        street: 'Elite Business Office Tower B, Fl 18',
        city: 'Branch A',
    ...
    wishlist: ['ZOAL Royal Saffron Gold Latte', 'Premium Sudanese Toob'],
    savedCart: [
    ...
    communicationHistory: [
      {
        id: 'comm-1',
        channel: 'WhatsApp',
        subject: 'Premium Sizing Check',
        body: 'Assalamu Alaikum Customer Amna, your custom Toob sizing has been updated.',
        date: '2026-07-10',
        status: 'Delivered'
      }
    ],
...
export default function EnterpriseCrm({ currentUser, orders, addLog }: EnterpriseCrmProps) {
  ...
  const customersWithOrders = useMemo(() => {
    return customers.map(cust => {
      ...
      const crmRewards = cust.rewards || [
        ...
        { id: 'rw-3', title: 'Premium Sudanese Toob Gold Stitch Accent Upgrade', pointsCost: 800, status: 'Locked' as const }
      ];
      ...
      // Tags
      const crmTags = cust.tags || (cust.id === 'ZL-CRM-1001' ? ['Saffron-Lover', 'VIP-Customer'] : cust.id === 'ZL-CRM-1002' ? ['High-Value', 'Elite'] : ['Standard-List']);
  ...
  const handleDeleteCustomer = (id: string, name: string) => {
    ...
    if (window.confirm(`Are you absolutely sure you want to permanently erase ${name}'s CRM profile and timeline records?`)) {
      ...
      addLog(`Erased Customer CRM Account`, name);
