                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                      <div className="bg-[#060606]/40 border border-white/5 rounded-xs p-5 text-left">
                        <h3 className="text-white text-[11px] uppercase font-display font-bold tracking-widest border-b border-white/5 pb-2.5 mb-4 flex items-center gap-2">
                          <Truck className="w-4.5 h-4.5 text-[#D4AF37]" /> {isAr ? 'تتبع طلبك' : 'Track Your Order'}
                        </h3>
                        <p className="text-zinc-500 text-xs mb-4 max-w-xl">
                          {isAr ? 'أدخل تفاصيل طلبك أدناه للتحقق من التحديثات المباشرة والحالة.' : 'Enter your order details below to check live updates and status.'}
                        </p>
                        <TrackOrder 
                    ...
                    >
                      <div className="bg-[#060606]/40 border border-white/5 rounded-xs p-4 flex gap-4 items-center justify-between mb-2">
                        <div className="relative w-full max-w-sm">
                          ...
                          <input
                            type="text"
                            placeholder={isAr ? 'البحث في العناصر المحفوظة...' : 'Search saved items...'}
                    ...
                    >
                      <div className="space-y-1">
                        ...
                        <p className="text-zinc-400 text-xs font-sans leading-relaxed">
                          {isAr 
                            ? 'تحقق من أحدث تحديثات الطلبات والعروض والتنبيهات هنا.' 
                            : 'Check your latest order updates, offers, and alerts here.'}
                        </p>
                      </div>
                      ...
                      {activeNotificationEngine.notifications.length === 0 ? (
                        ...
                        <div className="space-y-3">
                          <div className="flex justify-between items-center pb-2 border-b border-white/10">
                            ...
                            >
                              {isAr ? 'تحديد الكل كمعروء' : 'Mark all read'}
                            </button>
                          </div>
                  ...
                  {customerSubTab === 'reviews' && (
                    ...
                    >
                      ...
                      <div className="space-y-1">
                        <h3 className="text-white text-base font-display font-bold uppercase tracking-wider flex items-center gap-2">
                          <Star className="w-5 h-5 text-[#D4AF37]" /> {isAr ? 'تقييماتك وآراؤك' : 'Your Reviews & Feedback'}
                        </h3>
                        <p className="text-zinc-400 text-xs font-sans leading-relaxed">
                          {isAr 
                      ...
                      <div className="bg-[#060606]/80 border border-white/10 rounded-sm p-6 space-y-5 shadow-xl">
                        ...
                        >
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div className="space-y-1.5">
                              <label className="text-[10px] text-zinc-300 uppercase tracking-widest block font-semibold">
                                {isAr ? 'اختر التقييم' : 'Select Rating'}
                              </label>
                              <select
                                name="reviewRating"
                                className="w-full bg-black border border-white/10 rounded-xs p-2.5 text-xs text-white focus:outline-none focus:border-[#D4AF37]/50"
                          ...
                          <div className="space-y-1.5">
                            <label className="text-[10px] text-zinc-300 uppercase tracking-widest block font-semibold">
                              {isAr ? 'أخبرنا بالمزيد' : 'Tell us more'}
                            </label>
                            <textarea
                              name="reviewComment"
                              rows={4}
