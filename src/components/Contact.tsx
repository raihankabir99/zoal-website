            ...
            <div className="border border-white/5 rounded-sm divide-y divide-white/5 bg-[#050505] text-xs">
              ...
              <div className="p-5 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-zinc-500 mt-1"><a href={`mailto:${settings.email}`} className="hover:text-gold-pure transition-colors" dir="ltr">{settings.email}</a></p>
              ...
              <div className="p-5 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-zinc-500 mt-1 mb-1" dir="ltr">{settings.phone}</p>
                </div>
              </div>
              ...
              <div className="p-5 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-zinc-500 mt-1">{settings.address}</p>
                </div>
              </div>
            ...
            {success ? (
              <div className="p-6 border border-gold-pure/20 rounded-xs bg-gold-pure/5 text-center space-y-3 animate-fade-in">
                ...
                <p className="text-zinc-500 text-xs max-w-sm mx-auto font-sans leading-relaxed">
                  Your coordinates have been registered successfully in our sovereign database. A senior boutique representative will contact you shortly.
                </p>
                <button
