...
export default function Checkout({
  ...
  return (
    <div className="bg-black text-white min-h-screen pt-[60px] sm:pt-[84px] md:pt-[88px] lg:pt-[92px] pb-20 select-none">
      <div className="max-w-7xl mx-auto px-3.5 sm:px-6 lg:px-8">
        
        {/* Head */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-white/5 pb-3 sm:pb-6 mb-4 sm:mb-10 gap-2 sm:gap-4">
          <div>
            <button
              type="button"
              onClick={onBackToCart}
              className="inline-flex items-center space-x-1 sm:space-x-2 rtl:space-x-reverse text-[#D4AF37] hover:text-white transition-colors text-[11px] sm:text-xs font-semibold uppercase tracking-widest mb-1 sm:mb-2 cursor-pointer min-h-[44px] sm:min-h-0 py-1"
            >
              <ArrowLeft className="w-3.5 h-3.5 sm:w-4 sm:h-4 rtl:rotate-180" />
              <span>{t('checkout.back', { defaultValue: 'Back to Basket' })}</span>
            </button>
            <h1 className="text-lg sm:text-3xl font-semibold tracking-wider font-display uppercase text-white leading-tight sm:leading-normal">
        ...
        <form onSubmit={handleSubmitOrder} className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-8 items-start">
          ...
          <div className="lg:col-span-7 space-y-4 sm:space-y-6">
            ...
            <h2 className="text-[#f2f7da] text-[11px] sm:text-[12px] leading-tight font-bold font-display uppercase tracking-widest border-b border-white/5 pb-2.5 sm:pb-3">
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="space-y-1">
                  <label htmlFor="checkout-name" className="text-[10px] text-zinc-400 uppercase tracking-widest font-semibold block">
                  ...
                  <input
                    ...
                    placeholder=""
                    className="w-full bg-black border border-white/5 rounded-sm min-h-[44px] px-3 py-2.5 sm:p-3 text-xs text-white focus:outline-none focus:border-gold-pure/45 transition-colors"
                  />
                </div>

                {/* 2. Phone Number */}
                <div className="space-y-1">
                  <label htmlFor="checkout-phone" className="text-[10px] text-zinc-400 uppercase tracking-widest font-semibold block">
                ...
                {/* 3. Email Address */}
                <div className="space-y-1">
                  <label htmlFor="checkout-email" className="text-[10px] text-zinc-400 uppercase tracking-widest font-semibold block flex items-center justify-between">
                ...
                {!isDigitalOnlyOrder && (
                  <>
                    <div className="space-y-1">
                      <label htmlFor="checkout-city" className="text-[10px] text-zinc-400 uppercase tracking-widest font-semibold block">
                    ...
                    {/* 5. Shipping Address */}
                    <div className="space-y-1">
                      <label htmlFor="checkout-address" className="text-[10px] text-zinc-400 uppercase tracking-widest font-semibold block">
                    ...
                    <div className="flex items-center justify-between">
                      <label className="text-xs sm:text-[10px] text-zinc-300 uppercase tracking-wider sm:tracking-widest font-bold flex items-center gap-1.5">
                        <span>📍 {i18n.language === 'ar' ? 'موقع التوصيل الفاخر' : 'Select Your Delivery Location'}</span>
                      </label>
                      <button
                        type="button"
              ...
              {hasSelectedDeliveryLocation && (
                <div className="space-y-2">
                  ...
                  <AnimatePresence mode="wait">
                    {!hasSelectedDeliveryLocation ? (
                      <motion.div
                        ...
                        className="relative overflow-hidden bg-black border border-gold-pure/30 rounded-sm p-3 sm:p-10 text-center space-y-3 sm:space-y-8 shadow-[0_20px_50px_rgba(0,0,0,0.5)] backdrop-blur-xl"
                      >
                        ...
                        <div className="w-[38px] h-[38px] sm:w-20 sm:h-20 rounded-full bg-gold-pure/5 flex items-center justify-center border border-gold-pure/20 mx-auto shadow-[0_0_40px_rgba(212,175,55,0.1)] relative">
                          <MapPin className="w-[18px] h-[18px] sm:w-10 sm:h-10 text-gold-pure" />
                          <div className="absolute inset-0 rounded-full animate-ping bg-gold-pure/10 opacity-20"></div>
                        </div>

                        <div className="space-y-1.5 sm:space-y-4">
                          <h4 className="text-white text-xs sm:text-lg font-bold uppercase tracking-wider sm:tracking-[0.3em] font-display mb-2 sm:mb-4">
                            {i18n.language === 'ar' ? '📍 حدد موقع التوصيل الخاص بك' : '📍 Select Your Delivery Location'}
                          </h4>
                          <div className="space-y-1.5 sm:space-y-4 text-zinc-400 text-[10px] sm:text-[11px] leading-relaxed max-w-md mx-auto font-sans">
                            <p className="text-zinc-200 font-medium text-xs sm:text-sm leading-5 sm:leading-relaxed mb-2 sm:mb-3">
                              {i18n.language === 'ar' 
                            ...
                            <div className="pt-1 sm:pt-2 space-y-1.5 sm:space-y-2 text-left rtl:text-right bg-white/[0.02] border border-white/5 rounded-xs p-3 sm:p-4">
                              <p className="text-zinc-500 uppercase tracking-widest text-[8.5px] sm:text-[9px] font-bold border-b border-white/5 pb-1 sm:pb-2 mb-1.5 sm:mb-2">
                              ...
                              <ul className="grid grid-cols-1 gap-1.5 sm:gap-2 text-[9.5px] sm:text-[10px] font-medium text-zinc-400">
                        ...
                        <div className="grid grid-cols-2 sm:flex sm:flex-row items-center justify-center gap-2 sm:gap-4 pt-2 sm:pt-4">
                          <button
                            type="button"
                            onClick={handleUseCurrentLocation}
                            className="flex items-center justify-center gap-1.5 sm:gap-2.5 px-3 sm:px-8 py-2.5 sm:py-4 bg-gold-pure text-black text-xs sm:text-[11px] font-bold uppercase tracking-wider sm:tracking-[0.2em] rounded-xs hover:bg-gold-light transition-all active:scale-95 shadow-[0_10px_30px_rgba(212,175,55,0.2)] w-full sm:w-auto sm:min-w-[220px] min-h-[44px]"
                          >
                          ...
                          <button
                            type="button"
                            onClick={scrollToMap}
                            className="flex items-center justify-center gap-1.5 sm:gap-2.5 px-3 sm:px-8 py-2.5 sm:py-4 bg-black border border-gold-pure/40 text-gold-pure text-xs sm:text-[11px] font-bold uppercase tracking-wider sm:tracking-[0.2em] rounded-xs hover:bg-gold-pure/5 hover:border-gold-pure transition-all active:scale-95 w-full sm:w-auto sm:min-w-[220px] min-h-[44px]"
                          >
                          ...
                          {savedAddresses.length > 0 && (
                            <button
                              ...
                              className="col-span-2 sm:col-auto flex items-center justify-center gap-1.5 sm:gap-2.5 px-3 sm:px-8 py-2.5 sm:py-4 bg-zinc-900 border border-white/10 text-white text-xs sm:text-[11px] font-bold uppercase tracking-wider sm:tracking-[0.2em] rounded-xs hover:bg-zinc-800 transition-all active:scale-95 w-full sm:w-auto sm:min-w-[220px] min-h-[44px]"
                            >
                      ...
                      >
                        ...
                        <div className="hidden md:block space-y-3 sm:space-y-4">
                          ...
                          <button
                            ...
                            className="w-full py-2 sm:py-2.5 text-[9px] font-bold text-zinc-600 hover:text-white uppercase tracking-[0.2em] transition-all duration-300 border border-white/5 hover:border-white/10 rounded-xs mt-1 min-h-[44px] sm:min-h-0"
                          >
                        ...
                        <div className="block md:hidden space-y-3.5 px-0.5 text-left rtl:text-right">
                          ...
                          {/* 6. OPEN MAP BUTTON & 7. CHANGE ADDRESS BUTTON */}
                          <div className="flex flex-col gap-2 pt-2 border-t border-white/5">
                            <a
                              href={googleMapsLink}
                              target="_blank"
                              rel="noopener noreferrer"
                              className="w-full min-h-[48px] px-4 bg-[#D4AF37]/10 hover:bg-[#D4AF37]/20 border border-[#D4AF37]/20 text-xs font-bold uppercase tracking-wider rounded-xs text-[#D4AF37] flex items-center justify-center gap-2 transition-all duration-200"
                            >
                              <span>{i18n.language === 'ar' ? 'افتح الخريطة 🗺️' : 'Open Map 🗺️'}</span>
                            ...
                            <button
                              ...
                              className="w-full min-h-[48px] text-[10px] font-bold text-zinc-400 hover:text-white uppercase tracking-[0.2em] transition-all duration-300 border border-white/10 hover:border-white/20 rounded-xs flex items-center justify-center"
                            >
                              {i18n.language === 'ar' ? 'تغيير العنوان' : 'Change Address'}
                            </button>
                          </div>
                        </div>
                      </motion.div>
                  ...
                  {hasSelectedDeliveryLocation && (
                    <div className="grid grid-cols-2 sm:flex sm:flex-row gap-2 w-full animate-fade-in">
                      <button
                        type="button"
                        onClick={handleUseCurrentLocation}
                        className="py-2.5 sm:py-3 px-3 sm:px-4 bg-zinc-950 hover:bg-zinc-900 text-white rounded-sm text-xs font-semibold tracking-wide flex items-center justify-center gap-1.5 sm:gap-2 border border-white/5 hover:border-gold-pure/40 active:scale-95 duration-200 cursor-pointer min-h-[44px]"
                      >
                        <Compass className="w-4 h-4 text-gold-pure shrink-0" />
                        <span>{i18n.language === 'ar' ? 'موقع GPS' : 'Use Current'}</span>
                      </button>
                      <button
                        type="button"
                        onClick={() => setIsMapExpanded(!isMapExpanded)}
                        className={`py-2.5 sm:py-3 px-3 sm:px-4 rounded-sm text-xs font-semibold tracking-wide flex items-center justify-center gap-1.5 sm:gap-2 border active:scale-95 duration-200 cursor-pointer min-h-[44px] ${
                          isMapExpanded
                      ...
                      >
                        ...
                        <span>{isMapExpanded ? (i18n.language === 'ar' ? 'تصغير الخريطة' : 'Minimize Map') : (i18n.language === 'ar' ? 'تكبير الخريطة' : 'Expand Map')}</span>
                      </button>
                    </div>
                  )}
                  ...
                  <div className="space-y-1.5 sm:space-y-2 pt-1 sm:pt-2">
                    ...
                    <div 
                      className={`relative rounded-xs border border-white/5 overflow-hidden group shadow-xl bg-[#0a0a0a] transition-all duration-300 ${
                        isMapExpanded ? 'h-[360px] sm:h-[450px]' : 'h-44 sm:h-56'
                      }`}
                    >
                      ...
                      <div className="absolute bottom-2 sm:bottom-3 right-2 sm:right-3 flex flex-col gap-1 sm:gap-1.5 z-10">
                        <button
                          type="button"
                          onClick={(e) => {
                            e.preventDefault();
                          ...
                          className="w-7 h-7 sm:w-8 sm:h-8 bg-black/95 border border-white/10 hover:border-gold-pure text-white hover:text-gold-pure rounded-xs flex items-center justify-center transition-all duration-150 cursor-pointer shadow-md"
                        >
                      ...
                      <div className="absolute top-2 sm:top-3 left-2 sm:left-3 z-10">
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="px-2.5 sm:px-3 py-1 sm:py-1.5 bg-black/95 hover:bg-zinc-900 text-white hover:text-gold-pure border border-white/10 hover:border-gold-pure text-[8.5px] sm:text-[9px] font-bold uppercase tracking-wider rounded-xs flex items-center gap-1 sm:gap-1.5 transition-all duration-150 cursor-pointer shadow-md"
                        >
            ...
            {hasSelectedDeliveryLocation && !isDigitalOnlyOrder && (
              ...
              >
                <h2 className="text-[#f2f7da] text-[11px] font-bold font-display uppercase tracking-widest border-b border-white/5 pb-3">Delivery Method</h2>
            ...
            <div className="bg-zinc-950 border border-white/5 rounded-sm p-4 sm:p-6 space-y-3 sm:space-y-4">
              ...
              {paymentMethod === 'mada' && (
                <div className="p-4 bg-black/60 border border-white/5 rounded-xs space-y-3 animate-fade-in">
                  <div className="space-y-1">
                    <label htmlFor="checkout-cardholder" className="text-[9px] text-zinc-500 uppercase tracking-widest">Cardholder Name:</label>
                    <input
                  ...
                  <div className="space-y-1">
                    <label htmlFor="checkout-cardnumber" className="text-[9px] text-zinc-500 uppercase tracking-widest">Mada / Credit Card Number:</label>
                    <input
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="space-y-1">
                      <label htmlFor="checkout-cardexpiry" className="text-[9px] text-zinc-500 uppercase tracking-widest">Expiry Date:</label>
                      <input
                    ...
                    <div className="space-y-1">
                      <label htmlFor="checkout-cardcvv" className="text-[9px] text-zinc-500 uppercase tracking-widest">Security CVV:</label>
          ...
          <div className="lg:col-span-5 bg-zinc-950 border border-white/5 p-4 sm:p-6 rounded-sm space-y-4 sm:space-y-6 lg:sticky lg:top-[72px] shadow-2xl mb-16 sm:mb-0">
            ...
            <div className="space-y-3 sm:space-y-4 max-h-[285px] overflow-y-auto pr-2 divide-y divide-white/5">
              {cart.map((item, idx) => (
                <div key={`checkout-cart-item-${item.product.id}-${item.selectedOption || ''}-${idx}`} className="flex items-center gap-2.5 sm:gap-3 pt-2.5 sm:pt-3 first:pt-0 text-xs">
                  
                  {/* Thumbnail Image */}
                  <div className="w-10 h-10 sm:w-12 sm:h-12 relative rounded-xs overflow-hidden bg-zinc-900 border border-white/5 shrink-0 flex items-center justify-center">
                    <SafeImage 
            ...
            <button
              type="submit"
              className="w-full py-3.5 sm:py-5 bg-[#D4AF37] hover:bg-white text-black font-display font-bold uppercase tracking-widest text-[11px] sm:text-[11.5px] rounded-sm transition-all duration-300 active:scale-95 flex items-center justify-center gap-3 cursor-pointer shadow-[0_0_20px_rgba(212,175,55,0.25)] min-h-[44px] sm:min-h-[48px]"
            >
