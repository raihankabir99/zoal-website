...
export function BlogComments({ postId, currentUser }: BlogCommentsProps) {
  ...
  return (
    <div className="space-y-12 border-t border-white/5 pt-16 mt-16 max-w-4xl mx-auto">
      {/* Header */}
      ...
      <div className="bg-zinc-950 border border-white/5 rounded-sm p-6 sm:p-8 relative overflow-hidden">
        ...
        {currentUser ? (
          <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
            ...
            <div className="space-y-2">
              <textarea
                ...
                className="w-full bg-black border border-white/10 rounded-xs p-4 text-xs sm:text-sm text-white placeholder:text-zinc-700 outline-none focus:border-gold-pure transition-all resize-none leading-relaxed tracking-wide"
              />
            </div>
          ...
          <div className="text-center py-6 max-w-md mx-auto space-y-5 relative z-10">
            <ShieldAlert className="w-8 h-8 text-gold-pure/40 mx-auto" />
      ...
      <div className="space-y-8">
        {loading ? (
          ...
          <div className="text-center py-12 border border-dashed border-white/5 rounded-xs">
            <MessageSquare className="w-8 h-8 text-zinc-800 mx-auto mb-4" />
            <p className="text-zinc-500 text-xs tracking-widest uppercase font-mono leading-relaxed">
