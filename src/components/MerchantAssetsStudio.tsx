...
export default function MerchantAssetsStudio() {
  ...
  const PRESET_ASSETS = [
    ...
    },
    {
      ...
      title: 'Custom Premium White Silk Thobe',
    ...
    <div className="bg-zinc-950 border border-gold-pure/20 rounded-sm p-6 sm:p-8 space-y-8 relative text-left">
      ...
      <div className="max-w-3xl">
        <h3 className="text-base font-display uppercase tracking-widest text-[#D4AF37] mb-2 flex items-center gap-1.5 font-bold">
          <ImageIcon className="w-4 h-4" /> Upload & Manage Images
        </h3>
          ...
          <form onSubmit={handleUploadSubmit} className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <label className="text-[10px] uppercase text-zinc-400 tracking-wider">Image Title</label>
                <input
                  type="text"
                  value={uploadTitle}
              ...
              <div className="space-y-1.5">
                <label className="text-[10px] uppercase text-zinc-400 tracking-wider">Select Category</label>
                <select
            ...
            <div className="space-y-2">
              <label className="text-[10px] uppercase text-zinc-400 tracking-wider">Upload Image</label>
              <div
              ...
              <div className="aspect-video w-full max-w-sm rounded bg-black/60 border border-white/5 relative overflow-hidden flex items-center justify-center">
                {uploadUrl ? (
                  ...
                  <div className="text-center p-4">
                    ...
                    <span className="text-[9px] text-zinc-500 uppercase tracking-widest block font-mono">No image selected</span>
                  </div>
                )}
              </div>
            </div>
