...
export default function Blog({ onPostSelect, currentUser }: BlogProps) {
  ...
  return (
    <div className="bg-black text-white min-h-screen pt-[50px] sm:pt-[84px] md:pt-[88px] lg:pt-[92px] relative">
      ...
      <section className="bg-zinc-950 border-t border-white/5 pt-4 pb-8 sm:py-32 overflow-hidden relative">
        ...
        <div className="max-w-4xl mx-auto px-2 sm:px-4 relative z-10 text-center space-y-4 sm:space-y-12">
          <div className="space-y-2 sm:space-y-4">
            <h2 className="text-[20px] sm:text-6xl font-bold tracking-normal sm:tracking-tight text-white font-display uppercase leading-none">{t('blog.stay_updated')}</h2>
            <p className="text-zinc-400 text-xs sm:text-lg max-w-2xl mx-auto font-light leading-relaxed">
              {t('blog.newsletter_desc')}
            </p>
          </div>

          {subscribed ? (
            <div className="p-4 sm:p-6 bg-gold-pure/5 border border-gold-pure/20 rounded-xs max-w-md mx-auto text-gold-pure text-xs sm:text-sm tracking-wider">
