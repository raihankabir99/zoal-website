        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <article className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <h1 className="text-2xl sm:text-4xl font-semibold tracking-wider font-display uppercase leading-tight">{selectedArticle.title}</h1>
              
              <div className="flex items-center space-x-4 text-xs text-zinc-500 font-mono pt-3 border-b border-white/5 pb-4">
          ...
          {ARTICLES.map((art) => (
            ...
            >
              ...
              <div className="border-t border-white/5 pt-4 mt-6 flex justify-between items-center">
                ...
                <span className="text-[9px] uppercase tracking-widest text-gold-pure group-hover:translate-x-1 duration-300 flex items-center gap-1 font-display">
