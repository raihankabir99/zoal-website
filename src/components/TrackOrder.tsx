...
export default function TrackOrder({ orders, setCurrentPage, isEmbedded = false }: TrackOrderProps) {
  ...
  const tr = {
    ...
    subtitle: t('track_order.subtitle', { defaultValue: 'Enter your order number below to view the latest delivery updates and shipment status.' }),
    orderNum: t('track_order.orderNum', { defaultValue: 'Order Number' }),
    orderNumPlaceholder: t('track_order.orderNumPlaceholder', { defaultValue: 'Order ID (e.g. ZL-9871)' }),
    email: t('track_order.email', { defaultValue: 'Email Address' }),
    emailPlaceholder: t('track_order.emailPlaceholder', { defaultValue: 'Email Address' }),
    btnTrack: t('track_order.btnTrack', { defaultValue: 'Track Package' }),
                  ...
                  orders.length === 0 ? (
                    ...
                    <div className="p-8 border border-dashed border-white/10 rounded-xs text-center space-y-3 bg-black/40">
                      ...
                      <div className="space-y-1">
                        <h4 className="text-white font-semibold text-sm uppercase font-display tracking-wider">No recent orders yet.</h4>
                        <p className="text-zinc-400 text-xs font-sans max-w-sm mx-auto">
                          Your recent purchases will appear here for quick tracking.
                        </p>
                      </div>
                      <button
