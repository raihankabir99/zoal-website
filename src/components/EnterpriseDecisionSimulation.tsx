  ...
  return (
    <div className="space-y-6 text-left animate-fade-in font-sans pb-12">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center border-b border-white/5 pb-4 gap-4">
        <div>
          <span className="text-[9px] tracking-[0.4em] text-gold-pure uppercase font-mono block mb-1">{t('simulation.tagline', 'PREDICTIVE SCENARIO SIMULATION')}</span>
          <h2 className="text-xl font-bold tracking-widest font-display uppercase text-white flex items-center gap-2">
            ...
            {t('simulation.title', 'Enterprise Decision Simulation Engine')}
          </h2>
        </div>
