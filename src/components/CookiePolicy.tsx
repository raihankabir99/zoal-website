    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
                    ...
                    {section.id === 'managing-preferences' && (
                      <div className="mt-8 space-y-8">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                          ...
                          <div className="bg-zinc-950/60 border border-gold-pure/20 rounded-sm p-6 relative flex flex-col justify-between overflow-hidden group hover:border-gold-pure/40 transition-all duration-300 text-start">
                          ...
                          <div className="bg-zinc-950/60 border border-white/5 hover:border-gold-pure/30 rounded-sm p-6 relative flex flex-col justify-between overflow-hidden group transition-all duration-300 text-start">
        ...
        <AnimatePresence>
          {showScrollTop && (
            <motion.button
              ...
              className="fixed bottom-6 right-4 sm:right-6 p-3 bg-[#D4AF37] hover:bg-white text-black rounded-full shadow-2xl transition-all duration-300 cursor-pointer print:hidden z-50 hover:scale-105 active:scale-95"
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="mt-10 sm:mt-16 pt-8 sm:pt-12 border-t border-white/5 text-center"
        >
