...
const ICON_PRESETS = [
  ...
  { name: 'Layers', label: 'Bespoke Layer' },
  { name: 'ImageIcon', label: 'Art Portfolio' },
  { name: 'Sliders', label: 'Curated' },
  { name: 'FolderPlus', label: 'Division' }
];

// Preset premium Unsplash image placeholders for ease of category creation
const IMAGE_PRESETS = [
  { url: 'https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?auto=format&fit=crop&q=80&w=400', label: 'Bespoke Coffee' },
...
export const CategoryManagement: React.FC<CategoryManagementProps> = ({
  ...
  const runSelfTestDiagnostics = () => {
    ...
    const interval = setInterval(() => {
      ...
      if (step >= 8) {
        ...
        addLog("Executed Automated Taxonomy Diagnostics Suite", "Security & Auditing System");
      }
    }, 250);
  };
  ...
  // Import Standard Corporate Taxonomy preset helper
  const handleImportPresetTaxonomy = () => {
    if (window.confirm("This will import the standard multi-level nested eCommerce category taxonomy (Food, Cosmetics, Household divisions and nested branches) into your current catalog. Continue?")) {
      ...
      alert("Corporate standard Taxonomy imported successfully! Explore Tree View to see nested subcategories.");
    }
  };
  ...
  return (
    <div className="space-y-6 text-left">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-white/5 pb-5">
        <div>
          <span className="text-[9px] tracking-[0.4em] text-gold-pure uppercase font-mono block mb-1">ZOAL ENTERPRISE TAXONOMY</span>
          <h2 className="text-xl font-bold tracking-widest font-display uppercase text-white">CATEGORY PORTFOLIO MATRIX</h2>
        ...
        <div className="flex flex-wrap items-center gap-2 font-mono text-[9px] uppercase">
          ...
          >
            <Sparkles className="w-3 h-3" /> Import Preset Taxonomy
          </button>
          ...
          >
            <Merge className="w-3 h-3" /> Merge Categories
          </button>
          ...
          <button 
            ...
            className="py-1.5 px-3 border border-white/5 hover:border-white/10 text-zinc-400 hover:text-white rounded-xs font-bold transition-all cursor-pointer flex items-center gap-1"
          >
            <Move className="w-3 h-3" /> Move Branch
          </button>
          ...
          >
            <Plus className="w-3.5 h-3.5 font-bold" /> Create Division
          </button>
        </div>
      </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="text-[10px] font-mono uppercase tracking-wider text-white font-bold">RBAC Permissions Shield</span>
      ...
      {/* 2. Professional Core Dashboard Statistics */}
      <div className="grid grid-cols-2 lg:grid-cols-6 gap-4">
        ...
        <div className="bg-zinc-950 border border-white/5 p-4 rounded-xs text-left relative overflow-hidden group hover:border-gold-pure/20 transition-all">
          ...
          <span className="text-[8px] font-mono text-zinc-500 uppercase tracking-widest block">Total Divisions</span>
        ...
        <div className="bg-zinc-950 border border-white/5 p-4 rounded-xs text-left relative overflow-hidden group hover:border-gold-pure/20 transition-all">
          ...
          <span className="text-[8px] font-mono text-zinc-500 uppercase tracking-widest block">Root Divisions</span>
          ...
          <div>
            <div className="flex items-center justify-between border-b border-white/5 pb-2.5">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-mono uppercase tracking-wider text-white font-bold">Automated Taxonomy Test Suite</span>
              </div>
              <button
              ...
              >
                ...
                {isRunningTests ? "Verifying..." : "Run System Diagnoses"}
              </button>
            </div>
            ...
            {testRunnerLogs.length > 0 ? (
              ...
              <div className="mt-6 border border-dashed border-white/5 p-5 text-center text-zinc-500 text-[9px] font-mono rounded-xs bg-black/20">
                Tap "Run System Diagnoses" to trigger automated end-to-end integration self-tests.
              </div>
            )}
          </div>
          ...
          <div>
            <div className="flex items-center justify-between border-b border-white/5 pb-2.5">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-mono uppercase tracking-wider text-white font-bold">Ecosystem Activity Audit</span>
              </div>
              <button 
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between border-b border-white/5 pb-2.5">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-mono uppercase tracking-wider text-white font-bold">Future Blueprint</span>
              </div>
            ...
            <div className="space-y-2 pt-1 font-mono text-[8.5px]">
              ...
              <div className="flex items-center gap-1.5 text-zinc-300">
                <span className="text-emerald-400">■</span>
                <span>Multichannel API Gateway Sync</span>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-stretch lg:items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              {isSortMode ? "Exit Sibling Sorting" : "Sort & Arrange Siblings"}
            </button>
          ...
          <div className="space-y-4 pt-2 border-t border-white/5">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-left font-mono text-[9px] uppercase">
              ...
              <div className="space-y-1">
                <label className="text-zinc-500 block">Status division</label>
                <select 
                  value={statusFilter}
              ...
              {/* Parent Filter */}
              <div className="space-y-1">
                <label className="text-zinc-500 block">Filter by parent branch</label>
                <select 
                  value={parentFilter}
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10.5px] font-mono text-gold-pure uppercase tracking-widest font-bold">
                {selectedIds.length} Category Divisions Selected
              </span>
            </div>
        ...
        {isSortMode ? (
          <div className="bg-zinc-950 border border-white/5 p-5 rounded-xs space-y-4 animate-fade-in text-left">
            <div className="flex justify-between items-center border-b border-white/5 pb-3">
              <div>
                <span className="text-[8px] font-mono text-gold-pure uppercase tracking-widest">Interactive Sorting Workspace</span>
              ...
              <div className="flex items-center gap-2 font-mono text-[9.5px]">
                ...
                >
                  <option value="root">Root Divisions Only</option>
                  {categories.map(c => (
                    <option key={c.id} value={c.id}>{c.name}</option>
                  ))}
                </select>
                ...
                {activeView === 'tree' && (
                  <div className="bg-zinc-950 border border-white/5 p-5 rounded-xs space-y-4 animate-fade-in">
                    <div className="border-b border-white/5 pb-2 text-[8.5px] font-mono uppercase text-zinc-500 tracking-wider flex justify-between">
                      <span>Interactive Hierarchy Taxonomy (Expand/Collapse as needed)</span>
                          ...
                          <div className="p-4 space-y-2 flex-grow">
                            ...
                            <div className="flex items-center gap-1.5 font-mono text-[8.5px] uppercase text-zinc-500">
                              {parentCat ? (
                                ...
                                <span className="text-zinc-600 italic">Root Division</span>
                              )}
                            </div>
                          </div>
                    ...
                    <table className="w-full text-xs font-sans">
                      <thead className="bg-zinc-900 border-b border-white/5 text-[9px] font-mono uppercase text-zinc-500 tracking-widest">
                        <tr>
                          ...
                          <th className="p-3">Icon & Division Name</th>
                          <th className="p-3">Slug</th>
                          <th className="p-3">Parent Branch</th>
                            ...
                            >
                              ...
                              <td className="p-3">
                                {parentCat ? (
                                  ...
                                  <span className="text-zinc-600 italic text-[10px]">Root Division</span>
                                )}
                              </td>
        ...
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-xs flex justify-end animate-fade-in">
          <div className="w-full max-w-xl bg-zinc-950 border-l border-white/10 h-full flex flex-col justify-between overflow-y-auto shadow-2xl relative">
            ...
            <div className="p-5 border-b border-white/5 flex justify-between items-center bg-zinc-900/60">
              <div>
                <span className="text-[8.5px] font-mono text-gold-pure uppercase tracking-widest block">Taxonomy Schema Configurator</span>
                <h3 className="text-sm font-bold text-white font-display tracking-wider uppercase mt-1">
                  {modalMode === 'edit' ? `Modify details: ${editingCategory?.name}` : "Architect New Category Division"}
                </h3>
              </div>
              <button 
            ...
            <form onSubmit={handleSaveCategory} className="p-6 flex-grow space-y-5 text-left text-xs font-sans">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  >
                    <option value="">None (Level-0 Root Division)</option>
              ...
              <div className="space-y-4 p-4 rounded-xs border border-white/5 bg-zinc-950/40">
                ...
                {/* Preset Fast Picker */}
                <div className="space-y-1">
                  <label className="text-zinc-500 font-mono text-[8px] uppercase block">Fast Taxonomy Preset Images</label>
                ...
                <div className="bg-zinc-900/60 border border-white/5 p-3 rounded-xs space-y-1 text-left">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <h4 className="text-[12px] text-[#8ab4f8] hover:underline cursor-pointer truncate font-medium">
                      {formSeoTitle || `${formName || "Category Division"} | Premium Coffee & Spices`}
                    </h4>
                    {/* Meta Description */}
              ...
              <div className="grid grid-cols-2 gap-4 pt-3 border-t border-white/5">
                ...
                {/* Status selector */}
                <div className="space-y-1">
                  <label className="text-zinc-400 uppercase tracking-wider font-mono text-[9px] block">Division Status</label>
                  <select 
                    value={formStatus}
        ...
        <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-xs flex items-center justify-center p-4 animate-fade-in">
          <div className="bg-zinc-950 border border-white/10 max-w-md w-full rounded-xs p-5 space-y-4 relative text-left">
            ...
            <div>
              ...
              <h3 className="text-sm font-bold text-white font-display uppercase tracking-widest mt-1">Move Category Branch</h3>
              <p className="text-[10px] text-zinc-400 mt-1">
