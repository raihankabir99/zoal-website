  ...
  return (
    <div className="space-y-6 text-left animate-fade-in font-sans pb-12">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center border-b border-white/5 pb-4 gap-4">
        <div>
          <span className="text-[9px] tracking-[0.4em] text-gold-pure uppercase font-mono block mb-1">{t('forecast.tagline', 'PREDICTIVE ANALYTICS')}</span>
          <h2 className="text-xl font-bold tracking-widest font-display uppercase text-white flex items-center gap-2">
            ...
            {t('forecast.title', 'Executive Forecast Center')}
          </h2>
        </div>
        <div className="flex items-center gap-3">
          ...
          >
            ...
            {t('forecast.new_model', 'Add Scenario')}
          </button>
          <button 
          ...
          >
            ...
            {t('forecast.export_csv', 'Export CSV')}
          </button>
        </div>
      </div>
