  ...
  return (
    <div className="bg-black text-white min-h-screen pt-[48px] sm:pt-[60px] md:pt-[80px] pb-10 md:pb-16">
      ...
      <div className="max-w-7xl mx-auto px-1 sm:px-6 lg:px-8">
        ...
        <div className="text-left rtl:text-right mb-0.5 sm:mb-1 md:mb-2.5">
        ...
        <div className="bg-[#030303] sm:bg-glass border border-white/5 rounded-sm px-1 pt-1 sm:pt-1.5 pb-0.5 md:p-3.5 mb-1 md:mb-3.5 space-y-0.5 md:space-y-2.5 relative z-30">
          ...
          <div className="flex justify-between items-center text-[8.5px] md:text-[10px] tracking-[0.15em] text-zinc-500 uppercase border-t border-white/5 pt-1.5 sm:pt-2 md:pt-3.5 mt-1 sm:mt-2 md:mt-3.5 mb-1.5 sm:mb-[4px] md:mb-0">
        ...
        {categoryHeaderDetails && (
          <div
            ...
            className="mb-1 md:mb-10 relative rounded-sm overflow-hidden border border-white/5 bg-[#000] group h-[96px] md:h-[240px]"
          >
        ...
        {filteredProducts.length === 0 ? (
          ...
          <motion.div 
            key={activeCategory}
            className="grid grid-cols-2 min-[480px]:grid-cols-3 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-[6px] md:gap-4 lg:gap-5"
          >
            {filteredProducts.map((product, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="group bg-zinc-900/40 border border-white/10 rounded-sm p-0 transition-all duration-500 hover:border-gold-pure/30 cursor-pointer flex flex-col justify-between h-full hover:shadow-[0_8px_30px_rgb(0,0,0,0.8)]"
                >
                  
                   {/* Aspect Ratio Box with zoom state */}
                  <div className={`rounded-t-sm overflow-hidden relative shrink-0 ${
                  ...
                  <div className="px-2 py-2 sm:px-2.5 sm:py-2 text-left rtl:text-right flex flex-col justify-between flex-grow">
                    <div>
                      <h3 className="font-display font-medium text-[8.5px] sm:text-[11.5px] leading-tight sm:leading-tight uppercase tracking-wider sm:tracking-wider text-white group-hover:text-gold-pure duration-300 line-clamp-2 sm:line-clamp-1 mb-0 z-10 relative">
                      ...
                      <p className="hidden sm:block text-zinc-500 text-[10px] sm:text-[10.5px] font-sans mt-1 sm:mt-1 line-clamp-2 leading-snug font-light sm:min-h-0">
                    ...
                    <div className="flex items-center justify-between mt-0.5 md:mt-1 pt-0.5 md:pt-1 border-t border-white/5">
