  ...
  return (
    <div className="space-y-6 text-left animate-fade-in font-sans">
      ...
      <div className="border-b border-white/5 pb-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <span className="text-[9px] tracking-[0.4em] text-gold-pure uppercase font-mono block mb-1">SOVEREIGN COGNITIVE ENGINE</span>
          <h2 className="text-xl font-bold tracking-widest font-display uppercase text-white">SOVEREIGN AI AUTOMATION CENTER</h2>
        </div>
      ...
      <div className="grid grid-cols-1 gap-6">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              {[
                ...
                { title: 'Model Priority', value: 'Gemini 3.5 Flash', subtitle: 'Sovereign high-speed engine', trend: 'Low latency guaranteed', color: 'text-gold-pure' }
              ].map((card, i) => (
        ...
        {activeTab !== 'dashboard' && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              >
                {isGenerating ? (
                  <>
                    ...
                    GENERATING BESPOKE COPYWRITING...
                  </>
                ) : (
                  <>
            ...
            {/* Generated Outputs / Playground Workspace */}
                    ...
                    {!isGenerating && generatedResult && (
                      ...
                      >
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              <div className="p-3 bg-black border border-white/5 rounded-xs space-y-1.5">
                                <span className="text-[8.5px] text-zinc-500 uppercase font-mono block">Bespoke Highlights</span>
                        ...
                        {activeTab === 'tagging_ai' && (
                          <div className="space-y-4">
                            <div className="p-3 bg-black border border-white/5 rounded-xs space-y-2">
                              <span className="text-[8.5px] text-zinc-500 uppercase font-mono block">Bespoke Tags Suggested</span>
                            ...
                            <div className="p-3 bg-black border border-white/5 rounded-xs space-y-2">
                              <span className="text-[8.5px] text-zinc-500 uppercase font-mono block">Sovereign Related Products (Reciprocal Upselling)</span>
                        ...
                        {activeTab === 'content_ai' && (
                          <div className="space-y-4">
                            ...
                            <div className="bg-black/30 border border-white/5 p-3 rounded-xs text-[9px] text-zinc-400 flex items-center justify-between">
                              <span>Ready to integrate into the Sovereign CMS panel?</span>
                              <button 
                                onClick={() => {
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-3 gap-3">
                              {[
                                ...
                                { label: 'Projected Q3 Profit', val: generatedResult.projectedProfit, sub: 'Sovereign Gross Margin' },
                            ...
                            <div className="p-3 bg-black border border-white/5 rounded-xs text-left space-y-1">
                              <span className="text-[8px] text-zinc-500 uppercase font-mono block">Sovereign Business Insights & Recommendations</span>
            ...
            <div className="bg-zinc-950 border border-white/5 p-5 rounded-xs space-y-5 flex flex-col justify-between">
              <div className="space-y-4">
                <div className="border-b border-white/5 pb-2">
                  ...
                  <p className="text-[8px] text-zinc-500 font-sans mt-0.5">Select and calibrate active AI models in the sovereign stack.</p>
                </div>
                ...
                <div className="space-y-3">
                  <div className="space-y-1.5">
                    ...
                    >
                      ...
                      <option value="gemini-3.5-pro">Gemini 3.5 Pro (Enterprise Analytical - Staged)</option>
                      <option value="gemini-2.5-flash">Gemini 2.5 Flash (Legacy Fast Handoff)</option>
                      <option value="deepmind-ultra-custom">DeepMind Ultra (Bespoke Fine-tuned - Future Ready)</option>
                    </select>
                  </div>
                ...
                <button 
                  onClick={async () => {
                    try {
                      ...
                      const data = await res.json();
                      if (data.success) {
                        alert("Sovereign AI configurations and active model mappings updated inside the master database!");
...
function generateMockFallback(toolType: string, product: Product, language: string, topic: string, tone: string) {
  ...
  if (toolType === 'product_ai') {
    if (isAr) {
      ...
      return {
        ...
        specifications: {
          'Origin': 'Sovereign Sudanese / Saffron Highland Yemen',
  ...
  "offers": {
    ...
    "availability": "https://schema.org/InStock"
      ...
      return {
        metaTitle: `Buy Luxury ${name} Online | AL ZOAL Sovereign Boutique`,
  ...
  if (toolType === 'tagging_ai') {
    return {
      tags: ['SovereignSelection', 'LuxuryHeritage', 'ArtisanalBatch', 'SaudiElite', 'AlZoalPrestige'],
  ...
  if (toolType === 'content_ai') {
    return {
      ...
      heading: `Sovereign Gatherings: ${topic || 'The Fine Lineage of Heritage Coffee'}`,
  ...
  if (toolType === 'business_ai') {
    return {
      ...
      segmentationAction: 'Deploy private WhatsApp voice notes from Concierge Desk with tailored sizing sheets.',
      ...
      reviewSentimentAnalysis: 'Highly positive sentiment (4.82 average). Patrons admire the gold-dusted wrapping and Sudanese authentic card accompanying each dispatch. A minor complaint on local delivery delay in Al-Khobar sector has been registered.',
