                    ...
                    {policySections.map((sect) => {
                      ...
                      return (
                        <button
                          ...
                          className={`text-start px-3 py-2 rounded-xs text-[10px] font-mono uppercase tracking-wider flex items-center justify-between transition-all ${
                            isActive 
                              ? 'bg-[#D4AF37]/10 text-[#D4AF37] border-s-2 border-[#D4AF37] ps-2' 
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      {/* Bullets lists */}
                      {section.bulletsEn && (
                        <div className="space-y-3 ps-4 sm:ps-6 border-s border-white/5 border-[#D4AF37]/20">
