...
export default function ReturnRefundPolicy() {
  ...
  const [expandedSections, setExpandedSections] = useState<Record<string, boolean>>({
    ...
    'non-returnable': false,
    'refund-policy': false,
    'exchange-policy': false,
    'damaged-incorrect': false,
    'how-to-request': false,
    'refund-processing-time': false,
    ...
    return [
      ...
      },
      {
        ...
        bulletsEn: [
          ...
          'Once the return window expires, the order is considered settled, final, and non-refundable.'
        ],
        bulletsAr: [
          ...
          'بمجرد انقضاء هذه الفترة المحددة، تعتبر المعاملة نهائية وغير قابلة للتعديل أو الاسترجاع.'
        ]
      },
      {
      ...
      },
      {
        ...
        icon: ShieldAlert,
        contentEn: 'In the rare event that you receive a physically damaged, defective, or incorrect item, ZOAL guarantees absolute and swift resolution. Please contact our support team within 24 hours of delivery.',
        ...
        bulletsEn: [
          ...
          'Provide our customer support team with your Order Number, clear photos of the issue, and a brief description.',
      ...
      },
      {
        ...
        bulletsEn: [
          ...
          'Alternative: Contact our WhatsApp Support or official support email with your order details.'
        ],
        bulletsAr: [
      ...
      },
      {
        ...
        icon: Mail,
        contentEn: 'Our dedicated luxury client specialists are available daily to assist you with any questions regarding your returns, custom tailoring, or exchange desires.',
        ...
        bulletsEn: [
          `WhatsApp Support: ${returnsConfig.supportWhatsApp}`,
          `Email Support: ${returnsConfig.supportEmail}`,
          `Toll-Free Phone: ${returnsConfig.supportPhone}`,
          `Boutique HQ Address: ${returnsConfig.supportAddressEn}`,
          `Operating Hours: ${returnsConfig.supportHoursEn}`
        ],
        bulletsAr: [
  ...
  return (
    <div 
      dir={isAr ? 'rtl' : 'ltr'}
      className="bg-black text-white min-h-screen pt-20 sm:pt-32 pb-12 sm:pb-20 px-2 sm:px-6 lg:px-8 font-sans selection:bg-[#D4AF37] selection:text-black overflow-hidden relative"
    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-1.5 px-2.5 py-1 sm:px-3.5 sm:py-1 rounded-full bg-[#D4AF37]/5 border border-[#D4AF37]/15">
            <Sparkles className="w-3 h-3 text-[#D4AF37] animate-pulse shrink-0" />
            <span className="text-[8px] sm:text-[9px] uppercase tracking-[0.2em] sm:tracking-[0.3em] font-display font-semibold text-[#D4AF37] text-center">
              {isAr ? 'ضمان الرضا وحقوق المستهلك الفاخرة' : 'Customer Guarantee'}
            </span>
          </div>
        </motion.div>
        ...
        <div className="text-center mb-6 sm:mb-16">
          ...
          >
            <span className="flex items-center gap-1.5">
              ...
              {isAr ? `آخر تحديث: اليوم` : `Last Updated: Today`}
            </span>
            <span className="hidden sm:inline text-zinc-800">|</span>
            <button 
              onClick={handlePrint}
              className="flex items-center gap-1.5 hover:text-[#D4AF37] transition-colors duration-300 print:hidden cursor-pointer bg-white/5 hover:bg-gold-pure/10 px-2.5 py-1 rounded-sm border border-white/5"
        ...
        <div className="mb-10 max-w-md mx-auto print:hidden">
          <div className="relative">
            <span className="absolute inset-y-0 end-3 flex items-center text-zinc-500">
                    ...
                    {policySections.map((sect) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <Icon className="w-3 h-3 text-gold-pure/60 shrink-0" />
                        </button>
                      );
                    })}
                  </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          {/* Sidebar Navigation */}
          <div className="hidden md:block md:col-span-4 sticky top-28 max-h-[calc(100vh-160px)] overflow-y-auto pe-2 pb-6 print:hidden scrollbar-none">
                ...
                {policySections.map((sec) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full text-start px-3 py-2.5 rounded-sm text-[10px] font-mono uppercase tracking-wider flex items-center justify-between transition-all duration-300 border border-transparent ${
                        isActive 
                          ? 'bg-[#D4AF37]/5 text-[#D4AF37] border-white/5 font-semibold' 
                          : 'text-zinc-500 hover:text-white hover:border-white/5'
                      }`}
                    >
                      <span className="truncate pe-2">{isAr ? sec.titleAr : sec.titleEn}</span>
          ...
          <div className="md:col-span-8 space-y-3.5 sm:space-y-6 md:space-y-8 print:w-full">
                ...
                return (
                  ...
                  >
                    <motion.div
                      ...
                      className={`p-2.5 sm:p-6 md:p-8 bg-[#040404]/30 backdrop-blur-md border rounded-sm transition-all duration-500 relative overflow-hidden shadow-2xl ${
                        isActive 
                      ...
                      >
                        <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
                          ...
                          <h2 className={`text-[11.5px] sm:text-sm md:text-base font-display uppercase tracking-wider sm:tracking-widest font-semibold leading-tight flex-1 min-w-0 transition-colors duration-500 ${
                            isActive ? 'text-[#D4AF37]' : 'text-white group-hover/hdr:text-[#D4AF37]'
                          }`}>
                            {isAr ? section.titleAr : section.titleEn}
                          </h2>
                        </div>

                        {/* Copy Section Anchor Link & Chevron */}
                        <div className="flex items-center gap-1 sm:gap-1.5 print:hidden shrink-0">
                          <button
                            onClick={(e) => copySectionLink(section.id, e)}
                            className="p-1 sm:p-1.5 rounded-sm hover:bg-white/5 text-zinc-500 hover:text-[#D4AF37] transition-colors duration-300 cursor-pointer relative group"
                          ...
                          <motion.div
                            ...
                            transition={{ duration: 0.2 }}
                            className="text-zinc-500 group-hover/hdr:text-[#D4AF37] transition-colors p-0.5 sm:p-1 shrink-0"
                          >
                      ...
                      <AnimatePresence initial={false}>
                        {expandedSections[section.id] && (
                          ...
                          >
                            ...
                            {/* Bullets lists */}
                            {section.bulletsEn && (
                              <div className="space-y-2.5 sm:space-y-3 ps-3 sm:ps-6 border-s border-white/5 border-[#D4AF37]/20">
                                {(isAr ? section.bulletsAr : section.bulletsEn).map((bullet, bIdx) => (
                                  <div key={bIdx} className="flex items-start gap-2.5 sm:gap-3 text-xs sm:text-[12.5px] text-zinc-300 font-sans leading-relaxed">
            ...
            <section className="scroll-mt-28 print:hidden" id="interactive-actions">
              <div className="p-3.5 sm:p-6 md:p-8 bg-zinc-950/45 border border-[#D4AF37]/15 rounded-sm shadow-2xl relative overflow-hidden">
                ...
                <h4 className="text-white text-lg font-display uppercase tracking-widest mb-3">
                  {isAr ? 'تقديم وإرسال طلب استرجاع فوري' : 'Initiate Return or Contact Support'}
                </h4>
                ...
                <p className="text-zinc-400 text-xs sm:text-[12.5px] leading-relaxed mb-6 font-sans">
                  {isAr
                    ...
                    : 'Would you like to return or exchange an eligible item? Use our secure self-service return portal below to submit a request, or contact our support representatives directly.'
                  }
                </p>
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/95 backdrop-blur-md">
              ...
              >
                ...
                <button
                  ...
                  className="absolute top-4 end-4 text-zinc-500 hover:text-[#D4AF37] transition-colors duration-300 cursor-pointer p-1"
                >
                  <X className="w-5 h-5" />
                </button>

                {!simSuccessData ? (
                  <form onSubmit={handleSimSubmit} className="space-y-5 text-start">
                    <div className="pb-3 border-b border-white/5 flex items-center gap-2.5">
                      ...
                      <h3 className="text-white text-[11px] uppercase tracking-widest font-semibold font-mono">
                        {isAr ? 'كونسيرج طلب الاسترجاع الفاخر' : 'Premium Return Support'}
                      </h3>
                    </div>
                  ...
                  <div className="text-center py-8 space-y-5">
                    ...
                    <div className="p-5 bg-black border border-white/5 rounded-xs space-y-3 font-mono text-[11px] text-start">
                    ...
                    >
                      {isAr ? 'إغلاق الكونسيرج' : 'Dismiss Portal'}
                    </button>
                  </div>
                )}
