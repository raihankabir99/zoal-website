...
export default function BusinessAutomationCenter({ orders, addLog, currentUser }: BusinessAutomationCenterProps) {
  ...
  const handleSaveConfig = () => {
    ...
    alert("Global Automation suite configurations written to persistent system parameters!");
  };
  ...
  return (
    <div className="space-y-6 text-left animate-fade-in font-sans">
      ...
      <div className="border-b border-white/5 pb-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <span className="text-[9px] tracking-[0.4em] text-gold-pure uppercase font-mono block mb-1">SYSTEM WORKFLOW SCHEDULER</span>
          <h2 className="text-xl font-bold tracking-widest font-display uppercase text-white">STORE AUTOMATION CENTER</h2>
        </div>
            ...
            <div className="bg-zinc-950 border border-white/5 p-5 rounded-xs space-y-4">
              ...
              <div className="space-y-3.5">
                {[
                  ...
                  { key: 'emailWelcome', title: 'Customer Welcome Letter', sub: 'Sent on verified account activation.' },
