...
export default function BusinessAutomationCenter({ orders, addLog, currentUser }: BusinessAutomationCenterProps) {
  ...
  const [executionLogs, setExecutionLogs] = useState<any[]>([
    ...
    { id: 'ex-103', action: 'WhatsApp Tracking Dispatch', target: '+966 50 123 4567', channel: 'WhatsApp API', status: 'Success', details: 'Dispatched shipping tracking link for Courier overnight transport.', time: '2026-07-16 10:20' },
