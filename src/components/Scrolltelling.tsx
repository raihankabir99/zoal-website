            ...
            return (
              ...
              >
                ...
                <div className={`md:col-span-7 ${!isEven ? 'md:order-last' : ''}`}>
                  <div className={`relative w-full rounded-sm overflow-hidden border border-white/5 bg-[#000] group aspect-[16/10] sm:aspect-[4/3]`}>
                    <SafeImage
                ...
                <div className="md:col-span-5 flex flex-col justify-center space-y-4 text-center md:text-left">
                  ...
                  <div className="pt-4">
                    ...
                    >
                      <span>{isAr ? item.button_text_ar || item.button_text || 'اكتشف المجموعة' : item.button_text || 'Explore Collection'}</span>
