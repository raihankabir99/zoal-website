        ...
        >
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-gold-pure/5 border border-gold-pure/15">
            ...
            <span className="text-[9px] uppercase tracking-[0.3em] font-display font-semibold text-gold-pure">
              {isAr ? 'مركز المساعدة الفاخر' : 'Luxury Concierge Help Center'}
            </span>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5 max-w-2xl mx-auto">
            ...
            <a
              ...
              className="py-3 px-4 border border-[#D4AF37]/40 hover:border-[#D4AF37] hover:bg-zinc-900/40 text-[#D4AF37] font-display font-semibold uppercase tracking-widest text-[10px] rounded-sm transition-all duration-300 active:scale-98 flex items-center justify-center gap-1.5"
            >
              <MessageCircle className="w-4 h-4 shrink-0 text-gold-pure" />
