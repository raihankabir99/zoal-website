export type BusinessCategory = 'coffee' | 'bakery' | 'market' | 'fashion' | 'thobes' | 'cosmetics';
...
export interface Product {
  ...
  isSeasonal?: boolean;
  isStaffPick?: boolean;
  isLuxuryChoice?: boolean;
  // Database snake_case mappings for persistence
  is_featured?: boolean;
  is_popular?: boolean;
  ...
  productType?: 'Food' | 'Drink' | 'Coffee' | 'Bakery' | 'Grocery' | 'Fashion' | 'Cosmetics' | 'Digital' | 'Gift Card' | 'Service';
  shippingFee?: number;
  deliveryDays?: number;
  sameDay?: boolean;
  pickup?: boolean;
  ...
  seoArabicSlug?: string;
  seoEnglishSlug?: string;
  ...
  specifications_ar?: Record<string, string> | string;
  materials_ar?: string | string[];
  care_instructions_ar?: string | string[];
  // Logistics & Pickup Extended Fields
  pickup_location?: string;
  pickup_ready_time?: string;
  pickup_open?: string;
  pickup_close?: string;
  pickup_friday_schedule?: string;
  pickup_instruction?: string;
  pickup_phone?: string;
  pickup_whatsapp?: string;
  pickup_email?: string;
