...
export const PRODUCTS: Product[] = [
  // 1. ZOAL COFFEE CAFE ('coffee')
  {
    ...
    isFeatured: true, // Added isFeatured
    images: [
  ...
  // 4. PREMIUM COLLECTIONS ('fashion')
  {
    ...
    specifications: {
      ...
      'Care': 'Premium dry laundering only'
    },
    story: 'The traditional Toob represents Sudanese design identity. We import these exquisite drapes directly from the finest artisans in Sudan where they are woven over two weeks, blending soft cotton fiber with reflective golden threads to catch the evening lights spectacularly.',
    rating: 5.0,
    inventory: 10,
    popular: true,
    reviews: [
