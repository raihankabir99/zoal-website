...
export const privacySections: PrivacySection[] = [
  ...
  },
  {
    ...
    content: {
      ...
      ar: 'تلتزم "زول" بحماية عمليات الدفع الإلكتروني. نحن لا نقوم بتخزين بيانات بطاقات الدفع الكاملة على قاعدة بيانات التطبيق الخاصة بنا. تتم معالجة المدفوعات من خلال مزودي الدفع المفعّلين في المنصة وفق ضوابط الأمان والخصوصية المعمول بها لديهم، وقد تتغير وسائل الدفع المتاحة بمرور الوقت.'
    }
  },
  {
    id: 'cookies',
