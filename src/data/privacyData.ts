...
export const privacySections: PrivacySection[] = [
  {
    ...
    icon: 'Shield',
    content: {
      en: 'Welcome to ZOAL, where premium quality meets authentic heritage. We hold our patrons’ trust in the highest regard. ZOAL is dedicated to respecting, honoring, and protecting your personal privacy. This comprehensive Privacy Policy defines the meticulous processes through which we collect, utilize, store, encrypt, and safeguard your personal information when visiting our platform, ordering from our boutique collections, or using our flagship dining and sartorial concierge services.',
  ...
  },
  {
    ...
    icon: 'Database',
    content: {
      en: 'To deliver our signature bespoke experience, ZOAL may collect certain elements of personal data. This information is acquired directly when you create a patron account, place a boutique purchase, or coordinate with our custom tailoring master artisan.',
    ...
    list: {
      en: [
        ...
        'Patron Account Information & login credentials',
  ...
  },
  {
    ...
    list: {
      en: [
        ...
        'Managing your private Patron Workspace Account',
  ...
  },
  {
    ...
    icon: 'Lock',
    content: {
      en: 'We deploy multi-layered, enterprise-grade safety protocols to protect your personal information. These robust defenses include complete Secure Sockets Layer (SSL) encryption for all web traffic, secure hashed password parameters, localized encrypted databases, strict internal operational access control, and constant proactive monitoring of network behaviors.',
  ...
  },
  {
    ...
    icon: 'Clock',
    content: {
      en: 'We store your personal data only for as long as necessary to accomplish the services outlined in this Privacy Policy, fulfill legal or tax record-keeping requirements in Saudi Arabia, manage active patron accounts, or resolve possible disputes. Perishable and transient order details are archived securely over set periods.',
  ...
  },
  {
    ...
    icon: 'UserCheck',
    content: {
      en: 'As a valued ZOAL patron, you hold comprehensive rights over your personal data under Saudi eCommerce and personal data protection regulations. You have the full authority to exercise the following:',
    ...
    list: {
      en: [
        ...
        'Request the complete deletion of your Patron Account and associated records',
  ...
  },
  {
    ...
    icon: 'Mail',
    content: {
      en: 'If you have any questions or wishes regarding our privacy practices, wish to assert your personal data rights, or want to coordinate directly with our data integrity officer, please contact our Patron Care office at your convenience via the official channels below:',
