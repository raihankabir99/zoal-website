...
export const DEFAULT_RETURNS_CONFIG: ReturnsConfig = {
  ...
  supportWhatsApp: "+966 50 123 4567",
  supportEmail: "sovereign@zoal.com",
  supportPhone: "800-ZOAL-LUX",
  supportAddressEn: "King Khalid Road, Al Hofuf, Al-Ahsa, Kingdom of Saudi Arabia",
  supportAddressAr: "طريق الملك خالد، الهفوف، الأحساء، المملكة العربية السعودية",
