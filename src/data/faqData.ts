...
export const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer: {
      en: 'Yes, orders can be cancelled within 1 hour of placement before they enter the preparation and roasting stage. To request a cancellation, please contact our Concierge Support immediately via WhatsApp at +966 56 769 9315 with your Order Number.',
  ...
  },
  {
    ...
    answer: {
      en: 'You can track your orders in real-time by logging into your account and visiting the Patron Workspace Dashboard. There, you can view the active status of your order, delivery milestones, and estimated delivery times.',
