...
export const cookiesSections: CookieSection[] = [
  ...
  },
  {
    ...
    icon: 'Lock',
    content: {
      en: 'ZOAL respects your data sovereignty. You have complete control over optional cookies and can alter your choices at any moment. Essential cookies must always remain active to ensure standard checkout, cart stability, and security workflows. Your choices are securely saved and remembered for all future sessions.',
      ar: 'تحترم "زول" سيادتكم المطلقة على بياناتكم الشخصية وتمنحكم السيطرة الكاملة على ملفات تعريف الارتباط الاختيارية. يجب أن تظل الملفات الأساسية نشطة دائماً لضمان استقرار السلة وأمان الشراء. يتم حفظ تفضيلاتكم بشكل آمن لتذكرها تلقائياً في زياراتكم القادمة.'
    }
  },
  {
  ...
  },
  {
    ...
    icon: 'Mail',
    content: {
      en: 'Should you have any inquiries, suggestions, or requests regarding how we manage your browser security or data options, our dedicated Sovereign Support team is available around the clock to assist you with proper luxury hospitality.',
