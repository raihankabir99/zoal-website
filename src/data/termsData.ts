...
export const termsSections: TermsSection[] = [
  {
    ...
    icon: 'CheckSquare',
    content: {
      en: 'By accessing, browsing, registering, or making a transaction on the ZOAL boutique platform, you unconditionally agree to be bound by these comprehensive Terms & Conditions. These terms establish a legally binding agreement between you, as our esteemed customer, and ZOAL. If you do not agree with any of the luxury service guidelines outlined herein, we respectfully request that you refrain from using our website and support features.',
  ...
  },
  {
    ...
    icon: 'UserCheck',
    content: {
      en: 'The ZOAL boutique platform is strictly reserved for individuals who are legally capable of entering into binding contracts under the applicable laws of their residential jurisdiction and the Kingdom of Saudi Arabia. By completing a transaction, you affirm that you are of legal age of consent or have obtained appropriate parental/guardian authorization to procure items from our high-fashion, culinary, and premium collections.',
  ...
  },
  {
    ...
    icon: 'User',
    content: {
      en: 'To elevate your experience and unlock premium services such as custom thobe tailoring profiling and private order tracking, you may create a private Customer Account. By doing so, you acknowledge and agree to the following responsibilities:',
  ...
  },
  {
    ...
    icon: 'ShoppingBag',
    content: {
      en: 'ZOAL takes meticulous care to describe and display all high-end specialty roasts, fine patisserie items, and custom tailored thobes as accurately as possible. However, please observe the following guidelines:',
  ...
  },
  {
    ...
    icon: 'FileText',
    content: {
      en: 'All orders submitted through the ZOAL website constitute an offer to purchase and are subject to formal confirmation by our support team. ZOAL retains absolute authority to reject, cancel, or limit any order due to product unavailability, credit card suspicion, localized delivery difficulties, or measurement ambiguities for custom tailoring. A formal digital invoice is transmitted to your registered email immediately after our systems authorize your order.',
  ...
  },
  {
    ...
    icon: 'XCircle',
    content: {
      en: 'Customers may request order cancellation prior to dispatch from our fulfillment centers. Once an order is officially packaged and in transit with our logistics couriers, it cannot be canceled. Custom tailoring orders can only be canceled within 2 hours of payment authorization, before our master tailors begin drafting, cutting, and stitching your custom fabrics.',
  ...
  },
  {
    ...
    icon: 'ShieldAlert',
    content: {
      en: 'By accessing our platform, you commit to maintaining ethical, civil interaction. You are strictly prohibited from uploading malicious software, attempting database access bypasses, submitting false measurements, abusing other customers, or executing scripts that degrade our server speeds.',
  ...
  },
  {
    ...
    icon: 'Mail',
    content: {
      en: 'If you require clarification on our terms, wish to coordinate regarding active orders, or want to obtain private support, please reach out directly to the ZOAL customer care suite via our designated high-priority channels:',
